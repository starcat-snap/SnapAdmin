...
namespace SnapAdmin\Core\DevOps\System\Command;
...
class OpenApiValidationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $apiType = match ($input->getOption('api-type')) {
            ...
            default => throw new \InvalidArgumentException('Invalid --api-type, must be one of "api"'),
        };
        ...
        $style = new SnapAdminStyle($input, $output);
     ...
     */
    private function renderErrorMessages(SnapAdminStyle $style, array $messages): void
    {
