...
class PackageAnnotationRule implements Rule
{
    ...
    public const PRODUCT_AREA_MAPPING = [
        ...
        'inventory' => [
            ...
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Product\\\\/',
        ],
        'content' => [
            '/SnapAdmin\\\\Core\\\\Content\\\\(Media|Category|Cms|ContactForm|LandingPage)\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Cms\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\LandingPage\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Contact\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Navigation\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Menu\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Footer\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Header\\\\/',
        ],
        'system-settings' => [
            ...
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Country\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Suggest\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Search\\\\/',
        ],
        'channel' => [
            '/SnapAdmin\\\\Core\\\\Content\\\\(MailTemplate|Seo|Sitemap)\\\\/',
            '/SnapAdmin\\\\Core\\\\System\\\\(Channel)\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Sitemap\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Captcha\\\\/',
        ],
        'checkout' => [
            ...
            '/SnapAdmin\\\\Frontend\\\\Checkout\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Account\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Address\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Checkout\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Maintenance\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Newsletter\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Page\\\\Wishlist\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Newsletter\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Pagelet\\\\Wishlist\\\\/',
        ],
        'services-settings' => [
            '/SnapAdmin\\\\Core\\\\Framework\\\\Store\\\\/',
        ],
        'frontend' => [
            '/SnapAdmin\\\\Frontend\\\\Theme\\\\/',
            '/SnapAdmin\\\\Frontend\\\\Controller\\\\/',
            '/SnapAdmin\\\\Frontend\\\\(DependencyInjection|Migration|Event|Exception|Framework|Test)\\\\/',
        ],
        'core' => [
