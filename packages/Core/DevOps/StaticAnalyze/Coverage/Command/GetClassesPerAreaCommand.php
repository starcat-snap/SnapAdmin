...
namespace SnapAdmin\Core\DevOps\StaticAnalyze\Coverage\Command;
...
#[AsCommand(
    ...
    description: 'Output all classes of the SnapAdmin-namespace aggregated by area.
...
class GetClassesPerAreaCommand extends Command
{
    ...
    public const NAMESPACE_PATTERN_DEFAULT = '#^SnapAdmin\\\\(Core|Administration)\\\\#';
    ...
    private function getClassesPerArea(): array
    {
        ...
        foreach ($this->getSnapAdminClasses() as $class => $path) {
            try {
     ...
     */
    private function getSnapAdminClasses(): array
    {
