...
* The `__get()` function allows access to all properties of the [SalesChannelProductEntity](https://github.com/snap/platform/blob/trunk/src/Core/Content/Product/SalesChannel/SalesChannelProductEntity.php)
...
* **Returns** [`SnapAdmin\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](./product-script-services-reference.md#pricecollectionfacade) | `null`
