...
## [services.cart (`SnapAdmin\Core\Checkout\Cart\Facade\CartFacade`)](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/CartFacade.php) {#cartfacade}
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemsFacade`](./cart-manipulation-script-services-reference.md#itemsfacade)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\ProductsFacade`](./cart-manipulation-script-services-reference.md#productsfacade)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\CartPriceFacade`](./cart-manipulation-script-services-reference.md#cartpricefacade)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\ErrorsFacade`](./cart-manipulation-script-services-reference.md#errorsfacade)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\StatesFacade`](./cart-manipulation-script-services-reference.md#statesfacade)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\DiscountFacade`](./cart-manipulation-script-services-reference.md#discountfacade)
...
* **Arguments:**
    ...
    * *`float|\PriceCollection`* **value**: The value of the discount, a float for percentage discounts or
      a `PriceCollection` for absolute discounts.
...
* **Examples:**
    * Add an absolute discount to the cart.
      ...
      {% raw %}
        ```twig
        {# @var services \SnapAdmin\Core\Framework\Script\ServiceStubs #}
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade) | `null`
...
* **Returns** `bool`
  ...
  Returns true if the given line-item or a line-item with the given id already exists in the collection, false
  otherwise.
* **Arguments:**
    * *`string|\ItemFacade`* **id**: The id or a line-item that should be checked if it already exists in the
      collection.
...
* **Arguments:**
    ...
    * *`float|\PriceCollection`* **value**: The value of the surcharge, a float for percentage surcharges or
      a `PriceCollection` for absolute surcharges.
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\CartPriceFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/CartPriceFacade.php) {#cartpricefacade}
...
* **Returns
  ** [`SnapAdmin\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\ContainerFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ContainerFacade.php) {#containerfacade}
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\PriceFacade`](./cart-manipulation-script-services-reference.md#pricefacade) | `null`
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade) | `null`
  ...
  Returns the new line-item as an `ItemFacade` or null if taking is not possible because the line-item has no sufficient
  quantity.
* **Arguments:**
    * *`int`* **quantity**: The quantity that should be taken.
    * *`string` | `null`* **key**: Optional: The id of the new line-item. A random UUID will be used if none is
      provided.
...
* **Returns
  ** [`SnapAdmin\Core\Framework\Script\Facade\ArrayFacade`](./miscellaneous-script-services-reference.md#arrayfacade)
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\DiscountFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/DiscountFacade.php) {#discountfacade}
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\ErrorsFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ErrorsFacade.php) {#errorsfacade}
...
* **Arguments:**
    ...
    * *`string` | `null`* **id**: An optional id that can be used to reference the error, if none is provided the $key
      will be used as id.
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Error\Error`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ItemFacade.php) {#itemfacade}
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\ItemsFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ItemsFacade.php) {#itemsfacade}
...
* **Arguments:**
    * *[`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)*
      **item**: The line-item that should be added.
* **Examples:**
    * Add an absolute discount to the cart.
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\PriceFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFacade.php) {#pricefacade}
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Tax\Struct\CalculatedTaxCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/CalculatedTaxCollection.php)
...
* **Returns
  ** [`SnapAdmin\Core\Checkout\Cart\Tax\Struct\TaxRuleCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/TaxRuleCollection.php)
...
* **Arguments:**
    *
    *[`SnapAdmin\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)*
    **price**: The provided price can be a fetched price from the database or generated over the `PriceFactory`
    statically
* **Examples:**
...
* `plus()` allows a price addition of the current price scope. The provided price will be recalculated via the quantity
  price calculator.
...
* `minus()` allows a price subtraction of the current price scope. The provided price will be recalculated via the
...
* `discount()` allows a percentage discount calculation of the current price scope. The provided value will be ensured
  to be negative via `abs(value) * -1`.

  The provided discount is interpreted as a percentage value and will be applied to the unit price and the total price
  as well.
* **Arguments:**
    * *`float`* **value**: The percentage value of the discount. The value will be ensured to be negative
      via `abs(value) * -1`.
* **Examples:**
...
* `surcharge()` allows a percentage surcharge calculation of the current price scope. The provided value will be ensured
  to be negative via `abs(value)`.

  The provided surcharge is interpreted as a percentage value and will be applied to the unit price and the total price
  as well.
* **Arguments:**
    * *`float`* **value**: The percentage value of the surcharge. The value will be ensured to be negative
      via `abs(value)`.
* **Examples:**
...
## [services.price (`SnapAdmin\Core\Checkout\Cart\Facade\PriceFactory`)](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFactory.php) {#pricefactory}
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\ProductsFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ProductsFacade.php) {#productsfacade}
...
* **Arguments:**
    * *`string|\LineItem|\ItemFacade`* **product**: The product that should be added. Either an existing `ItemFacade`
      or `LineItem` or alternatively the id of a product.
    * *`int`* **quantity**: Optionally provide the quantity with which the product line-item should be created, defaults
      to 1.
...
## [`SnapAdmin\Core\Checkout\Cart\Facade\StatesFacade`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Facade/StatesFacade.php) {#statesfacade}
