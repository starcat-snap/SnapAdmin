...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemsFacade`](./cart-manipulation-script-services-reference.md#itemsfacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\ProductsFacade`](./cart-manipulation-script-services-reference.md#productsfacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\CartPriceFacade`](./cart-manipulation-script-services-reference.md#cartpricefacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\ErrorsFacade`](./cart-manipulation-script-services-reference.md#errorsfacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\StatesFacade`](./cart-manipulation-script-services-reference.md#statesfacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\DiscountFacade`](./cart-manipulation-script-services-reference.md#discountfacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade) | `null`
...
* **Returns** [`SnapAdmin\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)

    The item that was added to the container.
* **Arguments:**
    * *[`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)* **item**: The item that should be added.
* **Examples:**
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Facade\PriceFacade`](./cart-manipulation-script-services-reference.md#pricefacade) | `null`
...
* **Returns** [`SnapAdmin\Core\Framework\Script\Facade\ArrayFacade`](./miscellaneous-script-services-reference.md#arrayfacade)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Error\Error`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
* **Arguments:**
    * *[`SnapAdmin\Core\Checkout\Cart\Facade\ItemFacade`](./cart-manipulation-script-services-reference.md#itemfacade)* **item**: The line-item that should be added.
* **Examples:**
    * Add an absolute discount to the cart.
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Tax\Struct\CalculatedTaxCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/CalculatedTaxCollection.php)
...
* **Returns** [`SnapAdmin\Core\Checkout\Cart\Tax\Struct\TaxRuleCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Checkout/Cart/Tax/Struct/TaxRuleCollection.php)
...
* **Arguments:**
    * *[`SnapAdmin\Core\Framework\DataAbstractionLayer\Pricing\PriceCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Pricing/PriceCollection.php)* **price**: The provided price can be a fetched price from the database or generated over the `PriceFactory` statically
* **Examples:**
