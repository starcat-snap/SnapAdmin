...
## [services.repository (`SnapAdmin\Core\Framework\DataAbstractionLayer\Facade\RepositoryFacade`)](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryFacade.php) {#repositoryfacade}
...
* **Returns
  ** [`SnapAdmin\Core\Framework\DataAbstractionLayer\Search\EntitySearchResult`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/EntitySearchResult.php)
...
* **Examples:**
    * Load a single product.
      ...
      {% raw %}
        ```twig
        {% set page = hook.page %}
		{# @var page \SnapAdmin\Storefront\Page\Page #}
...
* **Returns
  ** [`SnapAdmin\Core\Framework\DataAbstractionLayer\Search\IdSearchResult`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/IdSearchResult.php)
...
* **Returns
  ** [`SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\AggregationResultCollection`](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Search/AggregationResult/AggregationResultCollection.php)
...
## [services.store (`SnapAdmin\Core\Framework\DataAbstractionLayer\Facade\SalesChannelRepositoryFacade`)](https://github.com/snap/platform/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/SalesChannelRepositoryFacade.php) {#saleschannelrepositoryfacade}
...
however querying data and also loading associations is restricted to the entities that are also available through
the `store-api`.
