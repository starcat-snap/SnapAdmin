...
namespace SnapAdmin\Core\DevOps\Docs\Script;
...
use SnapAdmin\Core\Framework\Script\Execution\DeprecatedHook;
use SnapAdmin\Core\Framework\Script\Execution\FunctionHook;
use SnapAdmin\Core\Framework\Script\Execution\Hook;
use SnapAdmin\Core\Framework\Script\Execution\InterfaceHook;
use SnapAdmin\Core\Framework\Script\Execution\OptionalFunctionHook;
use SnapAdmin\Core\Framework\Script\Execution\TraceHook;
...
class HooksReferenceGenerator implements ScriptReferenceGenerator
{
    ...
    private function getHookClasses(): array
    {
        ...
        $snapClasses = ConstructFinder::locatedIn(__DIR__ . '/../../../..')
            ->exclude('*/Test/*', '*/vendor/*', '*/DevOps/StaticAnalyze*')
            ->findClassNames();

        foreach ($snapClasses as $class) {
