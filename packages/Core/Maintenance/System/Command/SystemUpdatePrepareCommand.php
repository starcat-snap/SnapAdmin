...
class SystemUpdatePrepareCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $eventDispatcher->dispatch(new UpdatePrePrepareEvent($context, $this->snapVersion, $newVersion));

        $eventDispatcher->dispatch(new UpdatePostPrepareEvent($context, $this->snapVersion, $newVersion));
