...
use SnapAdmin\Core\Checkout\Customer\Aggregate\CustomerGroupTranslation\CustomerGroupTranslationCollection;
use SnapAdmin\Core\Checkout\Customer\CustomerCollection;
use SnapAdmin\Core\Checkout\Document\Aggregate\DocumentTypeTranslation\DocumentTypeTranslationCollection;
use SnapAdmin\Core\Checkout\Order\OrderCollection;
use SnapAdmin\Core\Checkout\Payment\Aggregate\PaymentMethodTranslation\PaymentMethodTranslationCollection;
use SnapAdmin\Core\Checkout\Promotion\Aggregate\PromotionTranslation\PromotionTranslationCollection;
use SnapAdmin\Core\Checkout\Shipping\Aggregate\ShippingMethodTranslation\ShippingMethodTranslationCollection;
use SnapAdmin\Core\Content\Category\Aggregate\CategoryTranslation\CategoryTranslationCollection;
use SnapAdmin\Core\Content\Cms\Aggregate\CmsPageTranslation\CmsPageTranslationEntity;
use SnapAdmin\Core\Content\Cms\Aggregate\CmsSlotTranslation\CmsSlotTranslationEntity;
use SnapAdmin\Core\Content\ImportExport\ImportExportProfileTranslationCollection;
use SnapAdmin\Core\Content\LandingPage\Aggregate\LandingPageTranslation\LandingPageTranslationCollection;
use SnapAdmin\Core\Content\MailTemplate\Aggregate\MailHeaderFooter\MailHeaderFooterCollection;
use SnapAdmin\Core\Content\MailTemplate\Aggregate\MailTemplateType\MailTemplateTypeDefinition;
use SnapAdmin\Core\Content\MailTemplate\MailTemplateCollection;
use SnapAdmin\Core\Content\Media\Aggregate\MediaTranslation\MediaTranslationCollection;
use SnapAdmin\Core\Content\Newsletter\Aggregate\NewsletterRecipient\NewsletterRecipientCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductCrossSellingTranslation\ProductCrossSellingTranslationCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductFeatureSetTranslation\ProductFeatureSetTranslationCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductKeywordDictionary\ProductKeywordDictionaryCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductManufacturerTranslation\ProductManufacturerTranslationCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductReview\ProductReviewCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductSearchConfig\ProductSearchConfigEntity;
use SnapAdmin\Core\Content\Product\Aggregate\ProductSearchKeyword\ProductSearchKeywordCollection;
use SnapAdmin\Core\Content\Product\Aggregate\ProductTranslation\ProductTranslationCollection;
use SnapAdmin\Core\Content\Product\SalesChannel\Sorting\ProductSortingTranslationCollection;
use SnapAdmin\Core\Content\ProductStream\Aggregate\ProductStreamTranslation\ProductStreamTranslationCollection;
use SnapAdmin\Core\Content\Property\Aggregate\PropertyGroupOptionTranslation\PropertyGroupOptionTranslationCollection;
use SnapAdmin\Core\Content\Property\Aggregate\PropertyGroupTranslation\PropertyGroupTranslationCollection;
use SnapAdmin\Core\Content\Seo\SeoUrl\SeoUrlCollection;
use SnapAdmin\Core\Framework\App\Aggregate\ActionButtonTranslation\ActionButtonTranslationCollection;
use SnapAdmin\Core\Framework\App\Aggregate\AppScriptConditionTranslation\AppScriptConditionTranslationCollection;
use SnapAdmin\Core\Framework\App\Aggregate\AppTranslation\AppTranslationCollection;
use SnapAdmin\Core\Framework\App\Aggregate\CmsBlockTranslation\AppCmsBlockTranslationCollection;
use SnapAdmin\Core\Framework\App\Aggregate\FlowActionTranslation\AppFlowActionTranslationCollection;
...
use SnapAdmin\Core\System\Country\Aggregate\CountryStateTranslation\CountryStateTranslationCollection;
...
use SnapAdmin\Core\System\DeliveryTime\DeliveryTimeCollection;
...
use SnapAdmin\Core\System\SalesChannel\Aggregate\SalesChannelTranslation\SalesChannelTranslationCollection;
use SnapAdmin\Core\System\SalesChannel\Aggregate\SalesChannelTypeTranslation\SalesChannelTypeTranslationCollection;
use SnapAdmin\Core\System\SalesChannel\SalesChannelCollection;
use SnapAdmin\Core\System\Salutation\Aggregate\SalutationTranslation\SalutationTranslationCollection;
use SnapAdmin\Core\System\StateMachine\Aggregation\StateMachineState\StateMachineStateTranslationCollection;
use SnapAdmin\Core\System\StateMachine\StateMachineTranslationCollection;
...
use SnapAdmin\Core\System\Unit\Aggregate\UnitTranslation\UnitTranslationCollection;
