...
use SnapAdmin\Core\Framework\Plugin\Composer\Factory;
use SnapAdmin\Core\Framework\Plugin\PluginCollection;
use SnapAdmin\Core\Framework\Plugin\PluginEntity;
use SnapAdmin\Core\Framework\Plugin\Requirement\Exception\ComposerNameMissingException;
use SnapAdmin\Core\Framework\Plugin\Requirement\Exception\ConflictingPackageException;
use SnapAdmin\Core\Framework\Plugin\Requirement\Exception\MissingRequirementException;
use SnapAdmin\Core\Framework\Plugin\Requirement\Exception\RequirementStackException;
use SnapAdmin\Core\Framework\Plugin\Requirement\Exception\VersionMismatchException;
...
class RequirementsValidator
{
    ...
    private Composer $snapProjectComposer;
    ...
    public function validateRequirements(PluginEntity $plugin, Context $context, string $method): void
    {
        ...
        $this->snapProjectComposer = $this->getComposer($this->projectDir);
    ...
    private function checkComposerDependencies(
        ...
        foreach ($packages as $package) {
            // Ignore SnapAdmin plugins. They are checked separately in `validateInstalledPlugins`
