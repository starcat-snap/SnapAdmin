...
use SnapAdmin\Core\Framework\Test\TestCaseHelper\TestUser;
...
class AuthControllerTest extends TestCase
{
    ...
    {
        $client = $this->getBrowser(false);
        $configuration = $this->getContainer()->get('snap.jwt_config');
    ...
    public function testUnauthorizedWithPasswordGrantTypeWhenTokenExpired(): void
    {
        ...
        $admin = TestUser::createNewTestUser($connection, ['plugin:read']);
        ...
        $browser->request('GET', '/api/plugin');
        static::assertNotFalse($browser->getResponse()->getContent());
