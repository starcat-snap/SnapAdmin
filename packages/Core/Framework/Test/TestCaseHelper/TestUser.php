...
namespace SnapAdmin\Core\Framework\Test\TestCaseHelper;
...
class TestUser
{
    ...
    {
        return new TestUser('SnapAdmin', 'admin', Uuid::randomHex());
    }
    ...
    public static function createNewTestUser(Connection $connection, array $permissions = []): TestUser
    {
        ...
        return new TestUser('SnapAdmin', $username, Uuid::fromBytesToHex($userId));
    }
