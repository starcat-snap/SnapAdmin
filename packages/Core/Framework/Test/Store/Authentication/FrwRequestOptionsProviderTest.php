...
use SnapAdmin\Core\Framework\Store\Authentication\FrwRequestOptionsProvider;
...
class FrwRequestOptionsProviderTest extends TestCase
{
    ...
    public function testSetsFrwUserTokenIfPresentInUserConfig(): void
    {
        ...
        static::assertArrayHasKey('X-SnapAdmin-Token', $headers);
        static::assertEquals($frwUserToken, $headers['X-SnapAdmin-Token']);
    }
