DELETE
FROM `_dpkc_1n_relation1`;
DELETE
FROM `_dpkc_1n_relation2`;
DELETE
FROM `_dpkc_1n_relation3`;
DELETE
FROM `_dpkc_main_translation`;
DELETE
FROM `_dpkc_mn_relation1`;
DELETE
FROM `_dpkc_mn_relation2`;
DELETE
FROM `_dpkc_mn_relation_multi_pk`;
DELETE
FROM `_dpkc_1n_multi_relation`;
DELETE
FROM `_dpkc_1n_relation_on_another_id`;
DELETE
FROM `_dpkc_1n_relation_double_constraint`;
DELETE
FROM `_dpkc_1n_relation_double_constraint_two`;
DELETE
FROM `_dpkc_main`;
DELETE
FROM `_dpkc_other`;
DELETE
FROM `_dpkc_other_multi_pk`;
