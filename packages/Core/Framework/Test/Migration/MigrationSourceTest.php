...
namespace SnapAdmin\Core\Framework\Test\Migration;
...
use SnapAdmin\Core\Migration\V6_3\Migration1565270366PromotionSetGroupRule;
use SnapAdmin\Core\Migration\V6_3\Migration1565346846Promotion;
use SnapAdmin\Core\Migration\V6_3\Migration1566293076AddAutoIncrement;
use SnapAdmin\Core\Migration\V6_3\Migration1566460168UpdateTexts;
use SnapAdmin\Core\Migration\V6_3\Migration1566817701AddDisplayGroup;
use SnapAdmin\Core\Migration\V6_3\Migration1567431050ContactFormTemplate;
use SnapAdmin\Core\Migration\V6_3\Migration1568120239CmsSection;
use SnapAdmin\Core\Migration\V6_3\Migration1568120302CmsBlockUpdate;
use SnapAdmin\Core\Migration\V6_3\Migration1568645037AddEnqueueDbal;
use SnapAdmin\Core\Migration\V6_3\Migration1568901713PromotionDiscount;
use SnapAdmin\Core\Migration\V6_3\Migration1569403146ProductVisibilityUnique;
use SnapAdmin\Core\Migration\V6_3\Migration1570187167AddedAppConfig;
use SnapAdmin\Core\Migration\V6_3\Migration1570459127AddCmsSidebarLayout;
use SnapAdmin\Core\Migration\V6_3\Migration1570621541UpdateDefaultMailTemplates;
use SnapAdmin\Core\Migration\V6_3\Migration1570622696CustomerPasswordRecovery;
use SnapAdmin\Core\Migration\V6_3\Migration1570629862ClearCategoryBreadcrumbs;
use SnapAdmin\Core\Migration\V6_3\Migration1570684913ScheduleIndexer;
use SnapAdmin\Core\Migration\V6_3\Migration1571059598ChangeGreatBritainToUnitedKingdom;
...
class MigrationSourceTest extends TestCase
{
    ...
    public static function provideCoreRegexDataV6_3(): array
    {
        $cases = [
            ...
            ['SnapAdmin\Core\Migration\V6_3\Something\Migration1571059598ChangeGreatBritainToUnitedKingdom', false],
        ];
