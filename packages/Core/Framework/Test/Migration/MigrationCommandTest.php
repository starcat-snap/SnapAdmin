...
use SnapAdmin\Core\Framework\Migration\Command\MigrationCommand;
use SnapAdmin\Core\Framework\Migration\Command\MigrationDestructiveCommand;
use SnapAdmin\Core\Framework\Migration\Exception\MigrateException;
...
class MigrationCommandTest extends TestCase
{
    ...
    public function testCommandMigrateCacheClearBehaviourWithoutMigrations(): void
    {
        ...
        $command = new MigrationCommand($loader, $cache, $this->getContainer()->getParameter('kernel.snap_version'));
    ...
    public function testCommandMigrateCacheClearBehaviourWithOneMigration(): void
    {
        ...
        $command = new MigrationCommand($this->getContainer()->get(MigrationCollectionLoader::class), $cache, $this->getContainer()->getParameter('kernel.snap_version'));
