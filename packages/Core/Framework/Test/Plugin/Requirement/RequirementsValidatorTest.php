...
namespace SnapAdmin\Core\Framework\Test\Plugin\Requirement;
 ...
 * @internal
 *
 * @covers \SnapAdmin\Core\Framework\Plugin\Requirement\RequirementsValidator
 */
class RequirementsValidatorTest extends TestCase
{
    ...
    public function testValidateRequirementsDoNotMatch(): void
    {
        ...
        static::assertContains('snap/platform', $packages);
