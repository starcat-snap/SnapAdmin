...
namespace SnapAdmin\Core\Framework\Test\Plugin\KernelPluginLoader;

use Composer\Autoload\ClassLoader;
use PHPUnit\Framework\TestCase;
use SnapAdmin\Core\Framework\Plugin;
use SnapAdmin\Core\Framework\Plugin\Exception\KernelPluginLoaderException;
...
use SnapAdmin\Core\Framework\Test\Plugin\PluginIntegrationTestBehaviour;
...
class StaticKernelPluginLoaderTest extends TestCase
{
    ...
    public function testExpectExceptionWithFakePlugin(): void
    {
        ...
        $this->expectException(KernelPluginLoaderException::class);
        $this->expectExceptionMessage('Failed to load plugin "SwagTest". Reason: Plugin class "SwagTest\SwagTestFake" must extend "SnapAdmin\Core\Framework\Plugin"');
        $loader->initializePlugins(TEST_PROJECT_DIR);
    }
