...
class PluginServiceTest extends TestCase
{
    ...
    public function testRefreshPluginWithoutExtraLabelProperty(): void
    {
        ...
        $errorFound = false;
        $errorString = 'Plugin composer.json has invalid "type" (must be "snap-platform-plugin"), or invalid "extra/snap-plugin-class" value, or missing extra.label property';
    ...
    private function assertPluginMetaInformation(PluginEntity $plugin): void
    {
        ...
        static::assertSame('snap AG', $plugin->getAuthor());
        static::assertSame('(c) by snap AG', $plugin->getCopyright());
