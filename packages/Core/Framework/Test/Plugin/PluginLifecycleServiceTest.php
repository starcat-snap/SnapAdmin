...
use SnapAdmin\Core\Framework\Plugin\Util\PluginFinder;
use SnapAdmin\Core\Framework\Plugin\Util\VersionSanitizer;
use SnapAdmin\Core\Framework\Struct\ArrayStruct;
use SnapAdmin\Core\Framework\Test\Migration\MigrationTestBehaviour;
...
class PluginLifecycleServiceTest extends TestCase
{
    ...
    public function testRemoveMigrationsCannotRemoveSnapAdminMigrations(): void
    {
        $this->removeMigrationsCannotRemoveSnapAdminMigrations($this->context);
    }
    ...
    public function testRemoveMigrationsCannotRemoveSnapAdminMigrationsWithNonStandardLanguage(): void
    {
        $this->removeMigrationsCannotRemoveSnapAdminMigrations($this->createNonStandardLanguageContext());
    }
    ...
    private function removeMigrationsCannotRemoveSnapAdminMigrations(Context $context): void
    {
        $this->pluginService->refreshPlugins($context, new NullIO());
        ...
        $_SERVER['FAKE_MIGRATION_NAMESPACE'] = 'SnapAdmin\\Core';
