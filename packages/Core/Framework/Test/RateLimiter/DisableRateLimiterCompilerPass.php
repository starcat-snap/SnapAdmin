...
namespace SnapAdmin\Core\Framework\Test\RateLimiter;

use SnapAdmin\Core\Framework\RateLimiter\NoLimitRateLimiterFactory;
...
class DisableRateLimiterCompilerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $rateLimiter = $container->getDefinition('snap.rate_limiter');
