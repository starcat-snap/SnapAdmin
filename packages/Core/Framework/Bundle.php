...
use SnapAdmin\Core\Framework\Adapter\Filesystem\PrefixFilesystem;
use SnapAdmin\Core\Framework\DependencyInjection\CompilerPass\BusinessEventRegisterCompilerPass;
...
abstract class Bundle extends SymfonyBundle
{
    ...
    /**
     * Returns a list of all action event class references of this bundle. The events will be registered inside the `\SnapAdmin\Core\Framework\Event\BusinessEventRegistry`.
     *
