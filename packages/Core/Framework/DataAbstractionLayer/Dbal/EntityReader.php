...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Dbal\Exception\ParentAssociationCanNotBeFetched;
...
class EntityReader implements EntityReaderInterface
{
    ...
    ): void
    {
        ...
        // the ids are extracted in the entity hydrator (see: \SnapAdmin\Core\Framework\DataAbstractionLayer\Dbal\EntityHydrator::extractManyToManyIds)
