...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Exception\InvalidAggregationQueryException;
...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Bucket\DateHistogramAggregation;
...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\AvgAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\CountAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\EntityAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MaxAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\MinAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\RangeAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\StatsAggregation;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Aggregation\Metric\SumAggregation;
...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Bucket\Bucket;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Bucket\DateHistogramResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Bucket\TermsResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\AvgResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\CountResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\EntityResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\MaxResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\MinResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\RangeResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\StatsResult;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\AggregationResult\Metric\SumResult;
...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Term\EntityScoreQueryBuilder;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Term\SearchTermInterpreter;
