...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\AbstractFieldResolver;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Exception\DefinitionNotFoundException;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Exception\EntityRepositoryNotFoundException;
...
class DefinitionInstanceRegistry
{
     ...
     * @internal
     *
     * @param array<string, class-string<EntityDefinition>> $definitionMap array of $entityName => $definitionServiceId, e.g. 'product' => '\SnapAdmin\Core\Content\Product\ProductDefinition'
