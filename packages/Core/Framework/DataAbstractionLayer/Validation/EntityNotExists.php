...
namespace SnapAdmin\Core\Framework\DataAbstractionLayer\Validation;
...
class EntityNotExists extends Constraint
{
    ...
    public function __construct(array $options)
    {
        ...
        if (!($options['criteria'] ?? null) instanceof Criteria) {
            throw new InvalidOptionsException(sprintf('Option "criteria" must be an instance of SnapAdmin\Core\Framework\DataAbstractionLayer\Search\Criteria for constraint %s', self::class), ['criteria']);
        }
