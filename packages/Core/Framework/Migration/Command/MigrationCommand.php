...
namespace SnapAdmin\Core\Framework\Migration\Command;
...
use SnapAdmin\Core\Framework\Migration\Exception\UnknownMigrationSourceException;
...
class MigrationCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if ($total > 0) {
            $this->cache->clear();
            $this->io->writeln('cleared the snap cache');
        }
