...
class FrameworkMigrationReplacementCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $migrationSourceV3->addMethodCall('addDirectory', [$bundleRoot . '/Migration/V6_3', 'SnapAdmin\Core\Migration\V6_3']);

        $migrationSourceV4 = $container->getDefinition(MigrationSource::class . '.core.V6_4');
        $migrationSourceV4->addMethodCall('addDirectory', [$bundleRoot . '/Migration/V6_4', 'SnapAdmin\Core\Migration\V6_4']);

        $migrationSourceV5 = $container->getDefinition(MigrationSource::class . '.core.V6_5');
        $migrationSourceV5->addMethodCall('addDirectory', [$bundleRoot . '/Migration/V6_5', 'SnapAdmin\Core\Migration\V6_5']);

        $migrationSourceV6 = $container->getDefinition(MigrationSource::class . '.core.V6_6');
        $migrationSourceV6->addMethodCall('addDirectory', [$bundleRoot . '/Migration/V6_6', 'SnapAdmin\Core\Migration\V6_6']);

        $migrationSourceV6 = $container->getDefinition(MigrationSource::class . '.core.V6_7');
        $migrationSourceV6->addMethodCall('addDirectory', [$bundleRoot . '/Migration/V6_7', 'SnapAdmin\Core\Migration\V6_7']);
    }
}
