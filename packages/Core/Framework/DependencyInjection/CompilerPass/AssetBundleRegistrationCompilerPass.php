...
use SnapAdmin\Core\Framework\Adapter\Asset\AssetPackageService;
...
class AssetBundleRegistrationCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        array_unshift($arguments, new Reference('snap.asset.asset.version_strategy'));
        array_unshift($arguments, new Reference('snap.asset.asset_without_versioning'));
