...
use SnapAdmin\Core\Framework\DataAbstractionLayer\FieldVisibility;
use SnapAdmin\Core\Framework\Struct\Struct;
use Twig\Environment;
use Twig\Source;
use Twig\Template;

if (!\function_exists('SnapAdmin\Core\Framework\Adapter\Twig\sw_get_attribute')) {
    /**
...
if (!\function_exists('SnapAdmin\Core\Framework\Adapter\Twig\sw_escape_filter')) {
    /**
     * Escapes a string.
     *
