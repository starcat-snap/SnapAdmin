...
use SnapAdmin\Core\Checkout\Cart\CachedRuleLoader;
...
use SnapAdmin\Core\Checkout\Payment\SalesChannel\CachedPaymentMethodRoute;
use SnapAdmin\Core\Checkout\Shipping\SalesChannel\CachedShippingMethodRoute;
use SnapAdmin\Core\Checkout\Shipping\ShippingMethodDefinition;
use SnapAdmin\Core\Content\Category\CategoryDefinition;
use SnapAdmin\Core\Content\Category\Event\CategoryIndexerEvent;
use SnapAdmin\Core\Content\Category\SalesChannel\CachedCategoryRoute;
use SnapAdmin\Core\Content\Category\SalesChannel\CachedNavigationRoute;
use SnapAdmin\Core\Content\Cms\CmsPageDefinition;
use SnapAdmin\Core\Content\LandingPage\Event\LandingPageIndexerEvent;
use SnapAdmin\Core\Content\LandingPage\SalesChannel\CachedLandingPageRoute;
...
use SnapAdmin\Core\Content\Product\Events\ProductChangedEventInterface;
use SnapAdmin\Core\Content\Product\ProductDefinition;
use SnapAdmin\Core\Content\Product\SalesChannel\CrossSelling\CachedProductCrossSellingRoute;
use SnapAdmin\Core\Content\Product\SalesChannel\Detail\CachedProductDetailRoute;
use SnapAdmin\Core\Content\Product\SalesChannel\Listing\CachedProductListingRoute;
use SnapAdmin\Core\Content\Product\SalesChannel\Review\CachedProductReviewRoute;
use SnapAdmin\Core\Content\ProductStream\ProductStreamDefinition;
use SnapAdmin\Core\Content\Property\Aggregate\PropertyGroupOption\PropertyGroupOptionDefinition;
...
use SnapAdmin\Core\Content\Property\PropertyGroupDefinition;
use SnapAdmin\Core\Content\Seo\Event\SeoUrlUpdateEvent;
use SnapAdmin\Core\Content\Sitemap\Event\SitemapGeneratedEvent;
use SnapAdmin\Core\Content\Sitemap\SalesChannel\CachedSitemapRoute;
use SnapAdmin\Core\Defaults;
use SnapAdmin\Core\Framework\Adapter\Translation\Translator;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Cache\EntityCacheKeyGenerator;
...
use SnapAdmin\Core\System\Country\SalesChannel\CachedCountryRoute;
use SnapAdmin\Core\System\Country\SalesChannel\CachedCountryStateRoute;
use SnapAdmin\Core\System\Currency\CurrencyDefinition;
use SnapAdmin\Core\System\Currency\SalesChannel\CachedCurrencyRoute;
use SnapAdmin\Core\System\Language\LanguageDefinition;
use SnapAdmin\Core\System\Language\SalesChannel\CachedLanguageRoute;
...
use SnapAdmin\Core\System\SalesChannel\Context\CachedBaseContextFactory;
use SnapAdmin\Core\System\SalesChannel\Context\CachedSalesChannelContextFactory;
use SnapAdmin\Core\System\SalesChannel\SalesChannelDefinition;
use SnapAdmin\Core\System\Salutation\SalesChannel\CachedSalutationRoute;
use SnapAdmin\Core\System\Salutation\SalutationDefinition;
use SnapAdmin\Core\System\Snippet\SnippetDefinition;
use SnapAdmin\Core\System\StateMachine\Loader\InitialStateIdLoader;
...
class CacheInvalidationSubscriber
{
    ...
    public function invalidateSnippets(EntityWrittenContainerEvent $event): void
    {
        if (!$this->fineGrainedCacheSnippet) {
            $this->cacheInvalidator->invalidate(['snap.translator']);
