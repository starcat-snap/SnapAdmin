...
abstract class Plugin extends Bundle
{
     ...
     * If needed, return true and SnapAdmin will execute `composer require` during the plugin installation.
     * When the plugins gets uninstalled, SnapAdmin executes `composer remove`
     */
