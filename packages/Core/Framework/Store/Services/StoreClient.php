...
use SnapAdmin\Core\Framework\Store\Struct\LicenseStruct;
...
use SnapAdmin\Core\Framework\Store\Struct\StoreActionStruct;
use SnapAdmin\Core\Framework\Store\Struct\StoreLicenseViolationStruct;
use SnapAdmin\Core\Framework\Store\Struct\StoreLicenseViolationTypeStruct;
use SnapAdmin\Core\Framework\Store\Struct\StoreUpdateStruct;
...
class StoreClient
{
    ...
    public function getPluginCompatibilities(Context $context, string $futureVersion, PluginCollection $pluginCollection): array
    {
        ...
        $response = $this->client->request(
            ...
            [
                ...
                'headers' => $this->getHeaders($context),
                'json' => [
                    'futureSnapAdminVersion' => $futureVersion,
                    'plugins' => $pluginArray,
                ],
            ]
        );
    ...
    {
        return $this->instanceService->getSnapAdminVersion();
    }
