...
use SnapAdmin\Core\Framework\Store\Event\FirstRunWizardFinishedEvent;
use SnapAdmin\Core\Framework\Store\Event\FirstRunWizardStartedEvent;
use SnapAdmin\Core\Framework\Store\Exception\LicenseDomainVerificationException;
use SnapAdmin\Core\Framework\Store\Exception\StoreLicenseDomainMissingException;
use SnapAdmin\Core\Framework\Store\Struct\AccessTokenStruct;
use SnapAdmin\Core\Framework\Store\Struct\DomainVerificationRequestStruct;
use SnapAdmin\Core\Framework\Store\Struct\ExtensionStruct;
use SnapAdmin\Core\Framework\Store\Struct\FrwState;
use SnapAdmin\Core\Framework\Store\Struct\LicenseDomainCollection;
use SnapAdmin\Core\Framework\Store\Struct\LicenseDomainStruct;
use SnapAdmin\Core\Framework\Store\Struct\PluginCategoryStruct;
use SnapAdmin\Core\Framework\Store\Struct\PluginRecommendationCollection;
use SnapAdmin\Core\Framework\Store\Struct\PluginRegionCollection;
use SnapAdmin\Core\Framework\Store\Struct\PluginRegionStruct;
use SnapAdmin\Core\Framework\Store\Struct\ShopUserTokenStruct;
use SnapAdmin\Core\Framework\Store\Struct\StorePluginStruct;
...
class FirstRunWizardService
{
    ...
    public function frwLogin(string $snapId, string $password, Context $context): void
    {
        $accessTokenResponse = $this->frwClient->frwLogin($snapId, $password, $context);
