...
use SnapAdmin\Core\Framework\Api\Exception\NoEntityClonedException;
use SnapAdmin\Core\Framework\Api\Exception\ResourceNotFoundException;
use SnapAdmin\Core\Framework\DataAbstractionLayer\Exception\DefinitionNotFoundException;
...
class ApiException extends HttpException
{
     ...
     */
    public static function missingPrivileges(array $permissions): SnapAdminHttpException
    {
        return new MissingPrivilegeException($permissions);
    }

    public static function missingReverseAssociation(string $entity, string $parentEntity): SnapAdminHttpException
    {
    ...
    public static function noEntityCloned(string $entity, string $id): SnapAdminHttpException
    {
     ...
     * @param string[] $fails
     */
    public static function expectationFailed(array $fails): SnapAdminHttpException
    {
     ...
     */
    public static function resourceNotFound(string $entity, array $payload): SnapAdminHttpException
    {
