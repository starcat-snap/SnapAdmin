...
namespace SnapAdmin\Core\Framework\Webhook\Handler;
...
use SnapAdmin\Core\Framework\DataAbstractionLayer\Write\Command\WriteTypeIntendException;
...
final class WebhookEventMessageHandler
{
    ...
    {
        $snapVersion = $message->getSnapAdminVersion();
