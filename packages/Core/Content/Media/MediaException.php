...
use SnapAdmin\Core\Content\Media\Exception\CouldNotRenameFileException;
use SnapAdmin\Core\Content\Media\Exception\DisabledUrlUploadFeatureException;
use SnapAdmin\Core\Content\Media\Exception\DuplicatedMediaFileNameException;
use SnapAdmin\Core\Content\Media\Exception\EmptyMediaFilenameException;
use SnapAdmin\Core\Content\Media\Exception\EmptyMediaIdException;
use SnapAdmin\Core\Content\Media\Exception\FileExtensionNotSupportedException;
use SnapAdmin\Core\Content\Media\Exception\IllegalFileNameException;
use SnapAdmin\Core\Content\Media\Exception\IllegalUrlException;
use SnapAdmin\Core\Content\Media\Exception\MediaFolderNotFoundException;
use SnapAdmin\Core\Content\Media\Exception\MediaNotFoundException;
use SnapAdmin\Core\Content\Media\Exception\MissingFileException;
use SnapAdmin\Core\Content\Media\Exception\MissingFileExtensionException;
use SnapAdmin\Core\Content\Media\Exception\StrategyNotFoundException;
use SnapAdmin\Core\Content\Media\Exception\ThumbnailCouldNotBeSavedException;
use SnapAdmin\Core\Content\Media\Exception\ThumbnailNotSupportedException;
use SnapAdmin\Core\Content\Media\Exception\UploadException;
