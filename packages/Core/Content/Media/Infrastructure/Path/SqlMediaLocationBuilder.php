...
use SnapAdmin\Core\Content\Media\Core\Application\MediaLocationBuilder;
use SnapAdmin\Core\Content\Media\Core\Event\MediaLocationEvent;
use SnapAdmin\Core\Content\Media\Core\Event\ThumbnailLocationEvent;
 ...
 * @internal
 *
 * @codeCoverageIgnore (see \SnapAdmin\Tests\Integration\Core\Content\Media\Infrastructure\Path\MediaLocationBuilderTest)
 */
#[Package('content')]
