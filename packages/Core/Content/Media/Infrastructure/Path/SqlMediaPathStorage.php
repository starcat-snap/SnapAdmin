...
use SnapAdmin\Core\Content\Media\Core\Application\MediaPathStorage;
use SnapAdmin\Core\Framework\Log\Package;
use SnapAdmin\Core\Framework\Uuid\Uuid;

/**
 * @codeCoverageIgnore (see \SnapAdmin\Tests\Integration\Core\Content\Media\Infrastructure\Path\MediaPathStorageTest)
 */
#[Package('core')]
