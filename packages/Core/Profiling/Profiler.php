...
namespace SnapAdmin\Core\Profiling;

use SnapAdmin\Core\Framework\Log\Package;
use SnapAdmin\Core\Profiling\Integration\ProfilerInterface;
...
{
    /**
     * Profilers will be activated over the snap.yaml file
     *
     ...
     * @return TReturn
     */
    public static function trace(string $name, \Closure $closure, string $category = 'snap', array $tags = [])
    {
