...
use SnapAdmin\Core\Framework\Api\Controller\FallbackController;
...
class Kernel extends HttpKernel
{
    ...
    )
    {
        ...
        $this->snapVersion = $version['version'];
        $this->snapVersionRevision = $version['revision'];
    ...
    protected function getKernelParameters(): array
    {
        ...
        return array_merge(
            ...
            [
                ...
                'kernel.snap_version' => $this->snapVersion,
