...
namespace SnapAdmin\Core\Test\PHPUnit\Extension;
...
use SnapAdmin\Tests\Unit\Core\Test\FeatureFlagExtensionTest;
...
class FeatureFlagExtension implements BeforeTestHook, AfterTestHook
{
    ...
    public function __construct(
        private readonly string $namespacePrefix = 'SnapAdmin\\Tests\\Unit\\',
