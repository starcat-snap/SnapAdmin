...
export default class Repository<EntityName extends keyof EntitySchema.Entities> {
    ...
    get schema(): EntityDefinition<any> {
        return SnapAdmin.EntityDefinition.get(this.entityName);
    }

    /**
     * Sends a search request to the server to find entity ids for the provided criteria.
     */
    searchIds(criteria: Criteria, context = SnapAdmin.Context.api): Promise<IdSearchResult> {
     ...
     */
    search(criteria: Criteria, context = SnapAdmin.Context.api): Promise<EntityCollection<EntityName>> {
        const headers = this.buildHeaders(context);
     ...
     */
    get(id: string, context = SnapAdmin.Context.api, criteria: Criteria | null = null): Promise<Entity<EntityName> | null> {
     ...
     */
    save(entity: Entity<EntityName>, context = SnapAdmin.Context.api): Promise<void | AxiosResponse> {
     ...
     */
    clone(entityId: string, behavior: $TSDangerUnknownObject, context = SnapAdmin.Context.api): Promise<unknown> {
        if (!entityId) {
     ...
     */
    saveAll(entities: EntityCollection<EntityName>, context = SnapAdmin.Context.api): Promise<unknown> {
     ...
     * @private
     */
    sendUpserts(changeset: $TSDangerUnknownObject[], failOnError: boolean, context = SnapAdmin.Context.api): Promise<void> {
     ...
     */
    assign(id: string, context = SnapAdmin.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    delete(id: string, context = SnapAdmin.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    syncDeleted(ids: string[], context = SnapAdmin.Context.api): Promise<void> {
        const headers = this.buildHeaders(context);
     ...
     */
    create(context = SnapAdmin.Context.api, id: string | null = null): Entity<EntityName> {
     ...
     */
    mergeVersion(versionId: string, context = SnapAdmin.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    deleteVersion(entityId: string, versionId: string, context = SnapAdmin.Context.api): Promise<AxiosResponse> {
        const headers = this.buildHeaders(context);
     ...
     */
    buildHeaders(context = SnapAdmin.Context.api): {
        Accept: string,
        ...
        const { hasOwnProperty } = SnapAdmin.Utils.object;
