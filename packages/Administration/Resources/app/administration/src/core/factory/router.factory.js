...
export default function createRouter(Router, View, moduleFactory, LoginService) {
    ...
    function addGlobalNavigationGuard(router) {
        ...
        router.beforeEach((to) => {
            ...
            const tokenHandler = new SnapAdmin.Helper.RefreshTokenHelper();
            ...
            if (to.meta.privilege && !SnapAdmin.Service('acl').can(to.meta.privilege)) {
    ...
    function convertRouteComponentToViewComponent(route) {
        const hasOwnProperty = SnapAdmin.Utils.object.hasOwnProperty;
    ...
    function getViewComponent(componentName) {
        return SnapAdmin.Application.view.getComponentForRoute(componentName);
    }

    function getAssetPath() {
        return SnapAdmin.Context.api.assetsPath;
    }
