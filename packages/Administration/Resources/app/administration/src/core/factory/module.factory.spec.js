...
const { Module, Application } = SnapAdmin;
...
describe('core/factory/module.factory.js', () => {
    ...
    it('should add settings item if feature flag is active', () => {
        ...
        expect(SnapAdmin.State.get('settingsItems').settingsGroups).toEqual(expectedSettingsItem);
    });
    ...
    it('should not add settings item if feature flag is deactivated', () => {
        ...
        expect(SnapAdmin.State.get('settingsItems').settingsGroups).toEqual({});
    });
