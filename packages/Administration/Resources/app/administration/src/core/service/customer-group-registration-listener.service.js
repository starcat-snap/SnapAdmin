const { Application, Service } = SnapAdmin;
...
export default function addCustomerGroupRegistrationListener(loginService) {
    ...
    async function checkForUpdates() {
        if (!SnapAdmin.Service('acl').can('customer.viewer')) {
            return;
        }
        ...
        const customers = await customerRepository.search(criteria, SnapAdmin.Context.api);
