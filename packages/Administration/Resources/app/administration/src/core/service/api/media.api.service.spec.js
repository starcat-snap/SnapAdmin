...
function getMediaApiService(client = null, loginService = null) {
    ...
    if (loginService === null) {
        loginService = createLoginService(client, SnapAdmin.Context.api);
    }
...
describe('storeService', () => {
    ...
    it('test getDefaultFolderId without result', async () => {
        ...
        const spyRepository = jest.spyOn(SnapAdmin.Service('repositoryFactory'), 'create').mockImplementation(() => {
            return {
                search: async () => {
