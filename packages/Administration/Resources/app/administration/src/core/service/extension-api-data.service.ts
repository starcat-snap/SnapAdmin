...
import { updateSubscriber, register, handleGet } from '@snap-admin/admin-extension-sdk/es/data';
import { get, debounce } from 'lodash';
import type { App } from 'vue';
import { selectData } from '@snap-admin/admin-extension-sdk/es/data/_internals/selectData';
import MissingPrivilegesError from '@snap-admin/admin-extension-sdk/es/privileges/missing-privileges-error';
    ...
    updateSubscriber(id, (value) => {
        ...
        function setObject(transferObject: transferObject, prePath: string|null = null): void {
            ...
            Object.keys(transferObject).forEach((property) => {
                ...
                if (SnapAdmin.Utils.hasOwnProperty(transferObject[property], 'getDraft', this) && typeof transferObject[property].getDraft === 'function') {
                    setObject({ [property]: SnapAdmin.Utils.object.cloneDeep(transferObject[property]) }, realPath);
                ...
                scope.$set(
                    ...
                    SnapAdmin.Utils.object.get(scope, parsedPath.pathToLastSegment),
        ...
        if (path.includes('.')) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
            scope.$set(SnapAdmin.Utils.object.get(scope, newPath), lastPath, value.data);
