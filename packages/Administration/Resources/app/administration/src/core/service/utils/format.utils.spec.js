...
import {date, dateWithUserTimezone, fileSize, toISODate} from 'src/core/service/utils/format.utils';
...
describe('src/core/service/utils/format.utils.js', () => {
    ...
    describe('date', () => {
        const setLocale = (locale) => {
            jest.spyOn(SnapAdmin.Application.getContainer('factory').locale, 'getLastKnownLocale')
                .mockImplementation(() => locale);
        };
        const setTimeZone = (timeZone) => SnapAdmin.State.commit('setCurrentUser', { timeZone });
    ...
    describe('currency', () => {
        const currencyFilter = SnapAdmin.Utils.format.currency;
