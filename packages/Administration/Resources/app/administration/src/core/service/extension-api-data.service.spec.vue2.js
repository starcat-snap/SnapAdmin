...
import { handleFactory, send } from '@snap-admin/admin-extension-sdk/es/channel';
import SerializerFactory from '@snap-admin/admin-extension-sdk/es/_internals/serializer';
    ...
    it('should update entity', async () => {
        ...
        jest.spyOn(window, 'addEventListener').mockImplementationOnce((event, handler) => {
            ...
            const data = {
                ...
                _callbackId: SnapAdmin.Utils.createId(),
            };
