...
SnapAdmin.Component.register('sw-flow-sequence-selector', swFlowSequenceSelector);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-sequence-selector'), {
        localVue,
        stubs: {
