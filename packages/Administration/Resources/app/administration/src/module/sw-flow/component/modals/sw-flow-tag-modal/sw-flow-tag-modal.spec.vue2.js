...
SnapAdmin.Component.register('sw-flow-tag-modal', swFlowTagModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-tag-modal'), {
        localVue,
        provide: {
            flowBuilderService: {
                getActionModalName: () => {},
        ...
        stubs: {
            'sw-entity-tag-select': await SnapAdmin.Component.build('sw-entity-tag-select'),
