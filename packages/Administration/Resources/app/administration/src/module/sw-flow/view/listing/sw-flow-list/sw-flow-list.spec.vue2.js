...
SnapAdmin.Component.register('sw-flow-list', swFlowList);
...
const mockBusinessEvents = [
    ...
    },
    {
        ...
        mailAware: true,
        aware: ['SnapAdmin\\Core\\Framework\\Event\\OrderAware'],
    },
];
...
async function createWrapper(privileges = [], hasSnippetFromApp = false, customFlowData = flowData) {
    return shallowMount(await SnapAdmin.Component.build('sw-flow-list'), {
        mocks: {
            $route: {
                query: {
                    page: 1,
