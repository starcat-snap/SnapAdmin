...
const { Mixin, Classes: { SnapAdminError } } = SnapAdmin;
    ...
    methods: {
        ...
        handleValid(field, val) {
            ...
            if (field.required && !value && typeof value !== 'boolean') {
                ...
                this.$set(this.errors, field.name, new SnapAdminError({
        ...
        helpText(field) {
            ...
            return objHelpText[this.currentLocale] ?? objHelpText[SnapAdmin.Context.app.fallbackLocale] ?? null;
        },
    },
};
