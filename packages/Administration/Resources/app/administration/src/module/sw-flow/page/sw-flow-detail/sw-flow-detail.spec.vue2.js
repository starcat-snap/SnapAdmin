...
SnapAdmin.Component.register('sw-flow-detail', swFlowDetail);
...
async function createWrapper(
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-detail'), {
        localVue,
...
describe('module/sw-flow/page/sw-flow-detail', () => {
    ...
    it('should be able to build sequence collection from config of flow template', async () => {
        ...
        jest.spyOn(SnapAdmin.Utils, 'createId')
    ...
    it('should be able to get rule data for flow template', async () => {
        ...
        const sequences = SnapAdmin.State.getters['swFlowState/sequences'];
