...
SnapAdmin.Component.register('sw-flow-generate-document-modal', swFlowGenerateDocumentModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-generate-document-modal'), {
        localVue,
        provide: {
            repositoryFactory: {
                create: () => {
