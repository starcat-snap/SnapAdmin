...
SnapAdmin.Component.register('sw-flow-detail-flow', swFlowDetailFlow);
SnapAdmin.Component.register('sw-flow-sequence', swFlowSequence);
SnapAdmin.Component.register('sw-flow-trigger', swFlowTrigger);
...
async function createWrapper(privileges = []) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-detail-flow'), {
        localVue,
        provide: {
            repositoryFactory: {
                create: () => ({
        ...
        stubs: {
            ...
            'sw-flow-sequence': await SnapAdmin.Component.build('sw-flow-sequence'),
...
describe('module/sw-flow/view/detail/sw-flow-detail-flow', () => {
    ...
    it('should not able to edit flow template', async () => {
        SnapAdmin.State.commit('swFlowState/setFlow', {
            eventName: 'checkout.customer',
            name: 'Flow 1',
            sequences: [{
                id: '1',
