...
SnapAdmin.Component.register('sw-flow-change-customer-status-modal', swFlowChangeCustomerStatusModal);

async function createWrapper() {
    const localVue = createLocalVue();
    localVue.use(Vuex);

    return shallowMount(await SnapAdmin.Component.build('sw-flow-change-customer-status-modal'), {
        localVue,
