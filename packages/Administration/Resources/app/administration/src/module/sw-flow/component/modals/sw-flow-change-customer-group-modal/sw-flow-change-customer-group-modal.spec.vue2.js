...
SnapAdmin.Component.register('sw-flow-change-customer-group-modal', swFlowChangeCustomerGroupModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-change-customer-group-modal'), {
        localVue,
        provide: {
            repositoryFactory: {
                create: () => {
