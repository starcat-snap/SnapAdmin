...
const { Component, Utils, Classes: { SnapAdminError } } = SnapAdmin;
    ...
    methods: {
        ...
        onChangeMailTemplate(id, mailTemplate) {
            ...
            if (!currentMailTemplate && mailTemplate) {
                SnapAdmin.State.commit('swFlowState/setMailTemplates', [...this.mailTemplates, mailTemplate]);
            }
        },
