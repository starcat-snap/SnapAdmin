...
SnapAdmin.Component.register('sw-flow-set-order-state-modal', swFlowSetOrderStateModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-set-order-state-modal'), {
        localVue,
        provide: {
            repositoryFactory: {
                create: () => {
