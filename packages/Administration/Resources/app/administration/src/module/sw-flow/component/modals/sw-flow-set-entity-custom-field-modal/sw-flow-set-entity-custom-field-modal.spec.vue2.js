...
SnapAdmin.Component.register('sw-flow-set-entity-custom-field-modal', swFlowSetEntityCustomFieldModal);
const fieldClasses = [
...
async function createWrapper(customField = customNormalField) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-set-entity-custom-field-modal'), {
        localVue,
        provide: {
            flowBuilderService: {
                getActionModalName: () => {},
