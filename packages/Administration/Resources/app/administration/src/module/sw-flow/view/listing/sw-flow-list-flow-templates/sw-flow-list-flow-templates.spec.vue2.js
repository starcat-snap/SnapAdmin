...
const { Context } = SnapAdmin;
const { EntityCollection } = SnapAdmin.Data;

SnapAdmin.Component.register('sw-flow-list-flow-templates', swFlowListFlowTemplates);
...
async function createWrapper(privileges = [], propsData = {}) {
    return shallowMount(await SnapAdmin.Component.build('sw-flow-list-flow-templates'), {
        propsData,
        mocks: {
            $route: {
                query: {
        ...
        stubs: {
            ...
            'sw-card': true,
            'sw-internal-link': await SnapAdmin.Component.build('sw-internal-link'),
            'router-link': {
                props: ['to'],
            ...
            'sw-icon': true,
            'sw-button': true,
            'sw-entity-listing': await SnapAdmin.Component.build('sw-entity-listing'),
