...
SnapAdmin.Component.register('sw-flow-event-change-confirm-modal', swFlowEventChangeConfirmModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-event-change-confirm-modal'), {
        propsData: {
            item: {
                id: 'action-name',
            },
...
describe('module/sw-flow/component/modals/sw-flow-event-change-confirm-modal', () => {
    ...
    it('should reset flow sequence when clicking on confirm button', async () => {
        ...
        SnapAdmin.State.commit('swFlowState/setSequences', new EntityCollection(
            '/flow_sequence',
            'flow_sequence',
            null,
