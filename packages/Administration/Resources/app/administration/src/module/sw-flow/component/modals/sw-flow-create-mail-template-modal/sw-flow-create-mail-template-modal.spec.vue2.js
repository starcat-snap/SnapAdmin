...
SnapAdmin.Component.register('sw-flow-create-mail-template-modal', swFlowCreateMailTemplateModal);
SnapAdmin.Component.register('sw-code-editor', SwCodeEditor);
...
async function createWrapper(privileges = []) {
    return shallowMount(await SnapAdmin.Component.build('sw-flow-create-mail-template-modal'), {
        ...
        stubs: {
            ...
            'sw-code-editor': await SnapAdmin.Component.build('sw-code-editor'),
