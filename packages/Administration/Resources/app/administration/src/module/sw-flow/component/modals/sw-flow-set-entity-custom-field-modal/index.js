...
const { Component, Mixin, Service } = SnapAdmin;
const { Criteria } = SnapAdmin.Data;
const { mapState } = Component.getComponentHelper();
const { SnapAdminError } = SnapAdmin.Classes;
...
export default {
    ...
    computed: {
        ...
        labelProperty() {
            return `config.label.${SnapAdmin.State.get('session').currentLocale}`;
        },
    ...
    methods: {
        ...
        onCustomFieldSetChange(id, customFieldSet) {
            ...
            SnapAdmin.State.commit('swFlowState/setCustomFieldSets', [...this.customFieldSets, customFieldSet]);
        ...
        onCustomFieldChange(id, customField) {
            ...
            SnapAdmin.State.commit('swFlowState/setCustomFields', [...this.customFields, customField]);
            this.customFieldValue = null;
            this.renderedFieldConfig = this.validateOptionSelectFieldLabel(customField.config);
