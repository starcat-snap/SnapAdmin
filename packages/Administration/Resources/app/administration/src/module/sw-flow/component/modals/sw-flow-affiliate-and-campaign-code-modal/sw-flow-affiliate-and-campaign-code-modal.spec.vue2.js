...
SnapAdmin.Component.register('sw-flow-affiliate-and-campaign-code-modal', swFlowAffiliateAndCampaignCodeModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-affiliate-and-campaign-code-modal'), {
        localVue,
        provide: {
            validationService: {},
            repositoryFactory: {
