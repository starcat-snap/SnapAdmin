...
SnapAdmin.Component.register('sw-flow-app-action-modal', swFlowAppActionModal);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-app-action-modal'), {
        localVue,
        provide: {
            validationService: {},
            repositoryFactory: {
