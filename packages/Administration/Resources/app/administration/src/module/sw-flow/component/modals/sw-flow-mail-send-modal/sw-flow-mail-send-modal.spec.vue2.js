...
SnapAdmin.Component.register('sw-flow-mail-send-modal', swFlowMailSendModal);
...
function mockMailTemplateData() {
    return [
        {
            id: 'mailTemplate1',
            description: 'SnapAdmin default template',
...
async function createWrapper(sequence = {}) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-flow-mail-send-modal'), {
        ...
        stubs: {
            ...
            'sw-data-grid': await SnapAdmin.Component.build('sw-data-grid'),
...
describe('module/sw-flow/component/sw-flow-mail-send-modal', () => {
    ...
    it('should show customer recipient when entity available', async () => {
        SnapAdmin.State.commit('swFlowState/setTriggerEvent', {
            data: {
                customer: '',
                order: '',
            },
