...
SnapAdmin.Component.register('sw-flow-sequence-action-error', swFlowSequenceActionError);

async function createWrapper() {
    const localVue = createLocalVue();
    localVue.use(Vuex);

    return shallowMount(await SnapAdmin.Component.build('sw-flow-sequence-action-error'), {
        localVue,
        stubs: {
...
describe('src/module/sw-flow/component/sw-flow-sequence-selector', () => {
    ...
    it('should able to delete action', async () => {
        ...
        const sequencesState = await SnapAdmin.State.getters['swFlowState/sequences'];
