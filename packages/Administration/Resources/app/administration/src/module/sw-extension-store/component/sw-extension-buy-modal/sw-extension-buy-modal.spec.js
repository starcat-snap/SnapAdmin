...
SnapAdmin.Application.addServiceProvider('licenseViolationService', () => {
    return LicenseViolationsService(SnapAdmin.Application.getContainer('service').storeService);
});

SnapAdmin.Application.addServiceProvider('appModulesService', () => {
    return {
        fetchAppModules: jest.fn()
    };
});

SnapAdmin.Application.addServiceProvider('storeService', () => {
    return {
...
SnapAdmin.Application.addServiceProvider('loginService', () => {
    return {
...
describe('src/module/sw-extension/component/sw-extension-buy-modal', () => {
    ...
    async function createWrapper(overrides) {
        ...
        localVue.mixin(SnapAdmin.Mixin.getByName('sw-extension-error'));

        const localWrapper = mount(await SnapAdmin.Component.build('sw-extension-buy-modal'), {
            localVue,
            propsData: {
            ...
            provide: {
                ...
                extensionStoreLicensesService: SnapAdmin.Service('extensionStoreLicensesService')
            },
            stubs: {
                'sw-modal': {
                ...
                'sw-alert': await SnapAdmin.Component.build('sw-alert'),
                ...
                'sw-gtc-checkbox': await SnapAdmin.Component.build('sw-gtc-checkbox'),
        ...
        SnapAdmin.Application.getApplicationRoot = () => { return localWrapper.vm; };
