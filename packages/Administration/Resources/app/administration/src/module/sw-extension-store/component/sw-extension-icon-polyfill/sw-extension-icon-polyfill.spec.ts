...
SnapAdmin.Component.register('sw-extension-icon-polyfill', SwExtensionIconFallback);

async function createWrapper() {
    return shallowMount(await SnapAdmin.Component.build('sw-extension-icon-polyfill'), {
        propsData: {
            src: 'path/to/image',
...
describe('src/module/sw-extension-store/component/sw-extension-icon-polyfill', () => {
    it('uses core component if exists', async () => {
        jest.spyOn(SnapAdmin.Component.getComponentRegistry(), 'has')
