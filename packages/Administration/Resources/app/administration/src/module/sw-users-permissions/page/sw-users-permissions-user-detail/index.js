    ...
    methods: {
        createdComponent() {
            ...
            const languagePromise = new Promise((resolve) => {
                SnapAdmin.State.commit('context/setApiLanguageId', this.languageId);
        ...
        loadUser() {
            ...
            return this.userRepository.get(this.userId, SnapAdmin.Context.api, this.userCriteria).then((user) => {
                this.user = user;
