...
describe('src/module/sw-extension/component/sw-extension-file-upload', () => {
    ...
    beforeEach(async () => {
        SnapAdmin.State.get('notification').notifications = {};
    ...
    it('should throw an error if the upload goes wrong', async () => {
        ...
        expect(Object.keys(SnapAdmin.State.get('notification').growlNotifications)).toHaveLength(0);
        ...
        await wrapper.vm.$nextTick();
        const growlNotifications = SnapAdmin.State.get('notification').growlNotifications;
