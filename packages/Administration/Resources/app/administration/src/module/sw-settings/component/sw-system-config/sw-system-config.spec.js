...
describe('src/module/sw-settings/component/sw-system-config/sw-system-config', () => {
    ...
    it('should return SnapAdminError when has error', async () => {
        await SnapAdmin.State.dispatch('error/addApiError', {
            expression: 'SYSTEM_CONFIG.null.dummyKey',
            error: new SnapAdminError({ code: 'dummyCode' }),
        });
        ...
        expect(error).toBeInstanceOf(SnapAdminError);
    });
