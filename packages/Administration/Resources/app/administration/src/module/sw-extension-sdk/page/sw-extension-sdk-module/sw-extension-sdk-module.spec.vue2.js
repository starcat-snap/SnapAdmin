...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-extension-sdk-module'), {
        localVue,
        propsData: {
            id: SnapAdmin.Utils.format.md5(JSON.stringify(module)),
        },
        stubs: {
            'sw-page': true,
            'sw-loader': true,
...
describe('src/module/sw-extension-sdk/page/sw-extension-sdk-module', () => {
    ...
    it('@slow should not time out with menu item', async () => {
        const moduleId = await SnapAdmin.State.dispatch('extensionSdkModules/addModule', module);
    ...
    it('should show language switch', async () => {
        await SnapAdmin.State.dispatch('extensionSdkModules/addModule', module);
    ...
    it('should show smart bar button', async () => {
        ...
        await SnapAdmin.State.dispatch('extensionSdkModules/addModule', module);
        SnapAdmin.State.commit('extensionSdkModules/addSmartBarButton', {
            locationId: 'jest',
