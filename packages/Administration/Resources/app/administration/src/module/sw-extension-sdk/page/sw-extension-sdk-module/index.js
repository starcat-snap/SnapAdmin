 ...
 */
SnapAdmin.Component.register('sw-extension-sdk-module', {
    template,
    ...
    computed: {
        module() {
            return SnapAdmin.State.get('extensionSdkModules').modules.find(module => module.id === this.id);
        },
        ...
        smartBarButtons() {
            return SnapAdmin.State.get('extensionSdkModules').smartBarButtons
