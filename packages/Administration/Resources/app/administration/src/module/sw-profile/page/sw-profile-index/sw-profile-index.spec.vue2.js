...
SnapAdmin.Component.register('sw-profile-index', swProfileIndex);

async function createWrapper(privileges = []) {
    const localVue = createLocalVue();
    localVue.directive('tooltip', {});

    return shallowMount(await SnapAdmin.Component.build('sw-profile-index'), {
        localVue,
        stubs: {
            'sw-page': {
...
describe('src/module/sw-profile/page/sw-profile-index', () => {
    beforeAll(() => {
        SnapAdmin.Service().register('timezoneService', () => {
    ...
    it('should be able to change new password', async () => {
        ...
        wrapper.vm.onChangeNewPassword('SnapAdmin');

        expect(wrapper.vm.newPassword).toBe('SnapAdmin');
    });
    ...
    it('should be able to change new password confirm', async () => {
        ...
        wrapper.vm.onChangeNewPasswordConfirm('SnapAdmin');

        expect(wrapper.vm.newPasswordConfirm).toBe('SnapAdmin');
    });
