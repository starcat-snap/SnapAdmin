...
SnapAdmin.Component.register('sw-profile-index-search-preferences', swProfileIndexSearchPreferences);
...
async function createWrapper() {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-profile-index-search-preferences'), {
        localVue,
        stubs: {
            'sw-card': await SnapAdmin.Component.build('sw-card'),
...
describe('src/module/sw-profile/view/sw-profile-index-search-preferences', () => {
    beforeAll(() => {
        SnapAdmin.State.registerModule('swProfile', swProfileStateMock);
    });
    ...
    it('should be able to select all', async () => {
        ...
        await SnapAdmin.State.commit('swProfile/setSearchPreferences', [{
            entityName: 'product',
            _searchable: false,
            fields: [
                {
    ...
    it('should contain a computed property, calling: defaultSearchPreferences', async () => {
        ...
        await SnapAdmin.State.commit('swProfile/setUserSearchPreferences', [
            {
                order: {
                    documents: {
