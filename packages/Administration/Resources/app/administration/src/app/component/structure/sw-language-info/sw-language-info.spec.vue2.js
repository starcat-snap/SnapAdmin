...
describe('src/app/component/structure/sw-language-info', () => {
    ...
    beforeEach(async () => {
        ...
        SnapAdmin.State.commit('context/setApiSystemLanguageId', '123456789');
        SnapAdmin.State.commit('context/setApiLanguage', {
            id: '123',
            parentId: '456',
        });

        wrapper = shallowMount(await SnapAdmin.Component.build('sw-language-info'), {
            stubs: {},
            mocks: {
    ...
    it('should not render the infoText when no language is set', async () => {
        SnapAdmin.State.commit('context/setApiLanguage', null);
    ...
    it('should not render the infoText when user is in default language', async () => {
        ...
        SnapAdmin.State.commit('context/setApiSystemLanguageId', '123');
    ...
    it('should render the infoText for a root language', async () => {
        SnapAdmin.State.commit('context/setApiSystemLanguageId', '987654312');
        SnapAdmin.State.commit('context/setApiLanguage', {
            id: '1a2b3c',
            parentId: null,
        });
