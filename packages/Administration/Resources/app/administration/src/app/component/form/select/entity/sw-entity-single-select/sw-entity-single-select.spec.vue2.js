...
async function createEntitySingleSelect(customOptions) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-entity-single-select'), {
        ...options,
        ...customOptions,
    });
}
...
describe('components/sw-entity-single-select', () => {
    ...
    it('should recognize non-existing entity and offer entity creation', async () => {
        ...
        const swOriginEntitySingleSelect = await SnapAdmin.Component.build('sw-entity-single-select');
