...
async function createWrapper() {
    return shallowMount(await SnapAdmin.Component.build('sw-filter-panel'), {
        propsData: {
            title: 'Filter',
            entity: 'product',
            filters,
        ...
        stubs: {
            'sw-boolean-filter': await SnapAdmin.Component.build('sw-boolean-filter'),
            'sw-select-field': await SnapAdmin.Component.build('sw-select-field'),
            ...
            'sw-icon': true,
            'sw-existence-filter': await SnapAdmin.Component.build('sw-existence-filter'),
...
SnapAdmin.Service().register('filterService', () => {
    return {
