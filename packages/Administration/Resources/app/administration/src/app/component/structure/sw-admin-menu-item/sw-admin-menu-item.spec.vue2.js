...
async function createWrapper({ propsData = {}, privileges = [] } = {}) {
    ...
    const aclService = new AclService(SnapAdmin.State);

    return shallowMount(await SnapAdmin.Component.build('sw-admin-menu-item'), {
        propsData: propsData,
        stubs: {
            'sw-icon': true,
...
describe('src/app/component/structure/sw-admin-menu-item', () => {
    ...
    it('should match route', async () => {
        ...
        SnapAdmin.State.commit('adminMenu/setAdminModuleNavigation', entries);
