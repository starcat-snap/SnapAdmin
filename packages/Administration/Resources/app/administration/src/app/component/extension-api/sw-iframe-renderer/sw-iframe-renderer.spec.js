...
import { location } from '@snap-admin/admin-extension-sdk';
...
describe('src/app/component/extension-api/sw-iframe-renderer', () => {
    beforeEach(async () => {
        ...
        Object.keys(SnapAdmin.State.get('extensions')).forEach((key) => {
            Vue.delete(SnapAdmin.State.get('extensions'), key);
        });

        // Clear sdkLocation store
        Object.keys(SnapAdmin.State.get('sdkLocation').locations).forEach((key) => {
            Vue.delete(SnapAdmin.State.get('sdkLocation').locations, key);
        });
    ...
    it('should render iFrame with replacement component', async () => {
        ...
        SnapAdmin.State.commit('sdkLocation/addLocation', {
            locationId: 'foo',
