...
const { mapState } = SnapAdmin.Component.getComponentHelper();

/**
 * @private
 */
SnapAdmin.Component.register('sw-license-violation', {
    template,
    ...
    mixins: [
        SnapAdmin.Mixin.getByName('notification'),
    ],
    ...
    computed: {
        ...
        pluginCriteria() {
            return new SnapAdmin.Data.Criteria(1, 50);
        },
        ...
        getPluginViolation() {
            ...
            return this.licenseViolationService.checkForLicenseViolations()
                .then(({ violations, warnings, other }) => {
                    SnapAdmin.State.commit('licenseViolation/setViolations', violations);
                    SnapAdmin.State.commit('licenseViolation/setWarnings', warnings);
                    SnapAdmin.State.commit('licenseViolation/setOther', other);
                })
                .finally(() => {
