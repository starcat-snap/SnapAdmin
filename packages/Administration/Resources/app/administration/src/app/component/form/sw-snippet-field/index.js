...
const { Component, State, Data: { Criteria } } = SnapAdmin;
...
Component.register('sw-snippet-field', {
    ...
    computed: {
        ...
        languageCriteria() {
            ...
            criteria.addFilter(Criteria.equals('id', SnapAdmin.Context.api.systemLanguageId));
    ...
    methods: {
        async createdComponent() {
            ...
            this.snippetSets = await this.snippetSetRepository.search(new Criteria(1, 25), SnapAdmin.Context.api);
        ...
        async getSystemDefaultLocale() {
            const languages = await this.languageRepository.search(this.languageCriteria, SnapAdmin.Context.api);
