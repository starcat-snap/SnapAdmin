...
describe('src/app/component/structure/sw-search-bar', () => {
    ...
    async function createWrapper(props, searchTypes = searchTypeServiceTypes, privileges = []) {
        ...
        swSearchBarComponent = await SnapAdmin.Component.build('sw-search-bar');
        ...
        return shallowMount(swSearchBarComponent, {
            ...
            stubs: {
                ...
                'sw-search-bar-item': await SnapAdmin.Component.build('sw-search-bar-item'),
    ...
    beforeAll(async () => {
        ...
        const apiService = SnapAdmin.Application.getContainer('factory').apiService;
    ...
    it('should search global with ES when adminEsEnable is true', async () => {
        SnapAdmin.Context.app.adminEsEnable = true;
        wrapper = await createWrapper({
            initialSearchType: '',
        }, {
            all: {
