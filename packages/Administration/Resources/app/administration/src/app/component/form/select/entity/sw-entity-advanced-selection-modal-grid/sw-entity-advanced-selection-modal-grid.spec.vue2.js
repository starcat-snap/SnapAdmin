...
async function createWrapper(isSelectable, tooltip) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-entity-advanced-selection-modal-grid'), {
        localVue,
        stubs: {
            'sw-entity-listing': await SnapAdmin.Component.build('sw-entity-listing'),
            'sw-data-grid-settings': await SnapAdmin.Component.build('sw-data-grid-settings'),
            'sw-button': true,
