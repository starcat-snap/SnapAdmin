...
const types = SnapAdmin.Utils.types;
...
Component.register('sw-tabs-item', {
    ...
    props: {
        ...
        errorTooltip: {
            ...
            required: false,
            default() {
                return SnapAdmin.Snippet.tc('global.sw-tabs-item.tooltipTabHasErrors');
            },
        },
        warningTooltip: {
            type: String,
            required: false,
            default() {
                return SnapAdmin.Snippet.tc('global.sw-tabs-item.tooltipTabHasWarnings');
            },
        },
    },
