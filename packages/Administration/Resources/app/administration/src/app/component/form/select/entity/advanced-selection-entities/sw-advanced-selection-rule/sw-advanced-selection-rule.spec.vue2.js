...
async function createWrapper() {
    ...
    return {
        wrapper: shallowMount(await SnapAdmin.Component.build('sw-advanced-selection-rule'), {
            localVue,
            provide: {
            ...
            stubs: {
                'sw-entity-advanced-selection-modal': await SnapAdmin.Component.build('sw-entity-advanced-selection-modal'),
                'sw-entity-listing': await SnapAdmin.Component.build('sw-entity-listing'),
                'sw-modal': await SnapAdmin.Component.build('sw-modal'),
