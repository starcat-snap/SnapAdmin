...
Component.register('sw-property-search', {
    ...
    methods: {
        ...
        showSearch() {
            ...
            this.propertyGroupOptionRepository.search(this.propertyGroupOptionCriteria, SnapAdmin.Context.api)
                .then((groupOptions) => {
        ...
        loadGroups() {
            this.propertyGroupRepository.search(this.propertyGroupCriteria, SnapAdmin.Context.api).then((groups) => {
                this.groups = groups;
        ...
        loadOptions() {
            ...
            this.propertyGroupOptionRepository.search(criteria, SnapAdmin.Context.api)
                .then((groupOptions) => {
