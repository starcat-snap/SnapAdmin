...
Component.register('sw-filter-panel', {
        ...
        criteria: {
            handler() {
                if (this.filterChanged) {
                    SnapAdmin.Service('filterService').saveFilters(this.storeKey, this.storedFilters).then(response => {
    ...
    methods: {
        createdComponent() {
            SnapAdmin.Service('filterService').getStoredFilters(this.storeKey).then(filters => {
                this.activeFilters = {};
