...
Component.register('sw-data-grid', {
    ...
    methods: {
        ...
        findUserSettingById() {
            return this.userConfigRepository.get(this.currentSetting.id, SnapAdmin.Context.api).then((response) => {
                if (!response) {
                    return;
                }
        ...
        createUserGridSetting() {
            const newUserGrid = this.userConfigRepository.create(SnapAdmin.Context.api);
        ...
        saveUserSettings() {
            ...
            this.userConfigRepository.save(this.currentSetting, SnapAdmin.Context.api).then(() => {
