...
const { Component, Mixin, Utils } = SnapAdmin;
const { Criteria, EntityCollection } = SnapAdmin.Data;
const { debounce, get } = SnapAdmin.Utils;
...
Component.register('sw-entity-single-select', {
    ...
    props: {
        ...
        entityCreationLabel: {
            ...
            required: false,
            default() {
                return SnapAdmin.Snippet.tc('global.sw-single-select.labelEntity');
            },
        },
    ...
    methods: {
        ...
        createNewEntity() {
            ...
            this.repository.save(entity, this.context).then(() => {
                ...
                SnapAdmin.Utils.debug.error('Only Entities with "name" as the only required field are creatable.');
                this.isLoading = false;
            });
        },
