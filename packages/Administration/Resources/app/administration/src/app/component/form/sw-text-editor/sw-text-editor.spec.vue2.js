...
async function createWrapper(allowInlineDataMapping = true) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-text-editor'), {
        ...
        stubs: {
            ...
            'sw-text-editor-link-menu': await SnapAdmin.Component.build('sw-text-editor-link-menu'),
...
describe('src/app/component/form/sw-text-editor', () => {
    ...
    it('should show the link url when you select a text block with a link', async () => {
        ...
        await addAndCheckSelection(wrapper, linkText, 0, 8, 'SnapAdmin');
        document.dispatchEvent(new Event('mouseup'));
    ...
    it('should be able to switch from active link to non link text', async () => {
        ...
        // select "No Link" after the "SnapAdmin" link was selected before
        const paragraphWithoutLink = document.getElementById('paragraphWithoutLink');
    ...
    it('should be able to switch from one link to another link', async () => {
        ...
        await addAndCheckSelection(wrapper, linkOne, 0, 8, 'SnapAdmin');
        document.dispatchEvent(new Event('mouseup'));
        ...
        // select "Google" after the "SnapAdmin" link was selected before
