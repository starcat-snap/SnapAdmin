...
SnapAdmin.Component.register('sw-image-slider', SwImageSlider);
...
async function createWrapper(propsData = {}, listeners = {}) {
    return shallowMount(await SnapAdmin.Component.build('sw-image-preview-modal'), {
        stubs: {
            'sw-icon': true,
            'sw-image-slider': await SnapAdmin.Component.build('sw-image-slider'),
        },
        listeners,
        propsData: {
            mediaItems,
