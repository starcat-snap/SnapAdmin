...
Component.register('sw-category-tree-field', {
    ...
    methods: {
        ...
        getTreeItems(parentId = null) {
            ...
            return this.globalCategoryRepository.search(criteria, SnapAdmin.Context.api).then((searchResult) => {
        ...
        searchCategories(term) {
            ...
            // search for categories
            return this.globalCategoryRepository.search(categorySearchCriteria, SnapAdmin.Context.api);
        },
