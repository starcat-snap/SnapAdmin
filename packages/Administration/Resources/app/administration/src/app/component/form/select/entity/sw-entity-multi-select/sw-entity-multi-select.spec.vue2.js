...
const createEntityMultiSelect = async (customOptions) => {
    ...
    const options = {
        ...
        stubs: {
            ...
            'sw-product-variant-info': await SnapAdmin.Component.build('sw-product-variant-info'),
            'sw-label': true,
        },
        propsData: {
            entity: 'test',
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-entity-multi-select'), {
        ...options,
        ...customOptions,
    });
};
