...
Component.register('sw-snippet-field-edit-modal', {
    ...
    computed: {
        ...
        currentAuthor() {
            return `user/${SnapAdmin.State.get('session').currentUser.username}`;
        },
    ...
    methods: {
        createdComponent() {
            ...
            this.snippetSets.forEach((snippetSet) => {
                ...
                const snippet = this.snippetRepository.create(SnapAdmin.Context.api);
        ...
        onSave() {
            ...
            this.editableSnippets.forEach((snippet) => {
                ...
                if (snippet.origin !== snippet.value) {
                    ...
                    responses.push(
                        this.snippetRepository.save(snippet, SnapAdmin.Context.api),
                    );
                    ...
                    responses.push(
                        this.snippetRepository.delete(snippet.id, SnapAdmin.Context.api),
                    );
                }
            });
