...
SnapAdmin.Service().register('conditionDataProviderService', () => {
...
async function createWrapper(propsData) {
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-condition-order-custom-field'), {
        stubs: {
            'sw-condition-base': await SnapAdmin.Component.build('sw-condition-base'),
            ...
            'sw-condition-operator-select': await SnapAdmin.Component.build('sw-condition-operator-select'),
        ...
        provide: {
            ...
            conditionDataProviderService: SnapAdmin.Service('conditionDataProviderService'),
            availableTypes: [],
