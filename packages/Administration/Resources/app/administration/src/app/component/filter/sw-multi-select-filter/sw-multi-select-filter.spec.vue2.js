...
const { Criteria, EntityCollection } = SnapAdmin.Data;
...
async function createWrapper(customOptions) {
    ...
    const options = {
        localVue,
        stubs: {
            'sw-base-filter': await SnapAdmin.Component.build('sw-base-filter'),
            'sw-entity-multi-select': await SnapAdmin.Component.build('sw-entity-multi-select'),
            ...
            'sw-loader': await SnapAdmin.Component.build('sw-loader'),
    ...
    return shallowMount(await SnapAdmin.Component.build('sw-multi-select-filter'), {
        ...options,
        ...customOptions,
    });
}
