...
Component.register('sw-language-info', {
    ...
    methods: {
        async refreshParentLanguage() {
            ...
            if (this.language.parentId !== null && this.language.parentId.length > 0) {
                this.parentLanguage = await this.languageRepository.get(this.language.parentId, SnapAdmin.Context.api);
                return;
            }

            this.parentLanguage = await this.languageRepository.get(this.systemLanguageId, SnapAdmin.Context.api);
        },
