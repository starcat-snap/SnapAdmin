...
function getRepository(
    ...
    if (!extension) {
        ...
        throw new Error(`Could not find an extension with the given name "${extensionName}" in the extension store (SnapAdmin.State.get('extensions'))`);
    }

    if (extension.integrationId) {
        return SnapAdmin.Service('repositoryFactory')
            .create(entityName, '', { 'sw-app-integration-id': extension.integrationId });
    }

    return SnapAdmin.Service('repositoryFactory').create(entityName);
}
...
export default function initializeExtensionDataLoader(): void {
    SnapAdmin.ExtensionAPI.handle('repositorySearch', async (
        {
            entityName,
            criteria = new SnapAdmin.Data.Criteria(),
            context,
        },
        ...
        try {
            ...
            const mergedContext = { ...SnapAdmin.Context.api, ...context };
    ...
    SnapAdmin.ExtensionAPI.handle('repositoryGet', (
        {
            entityName,
            id,
            criteria = new SnapAdmin.Data.Criteria(),
    ...
    SnapAdmin.ExtensionAPI.handle('repositorySave', (
        {
            entityName,
            entity,
            context,
    ...
    SnapAdmin.ExtensionAPI.handle('repositoryClone', (
        {
            entityName,
            behavior,
            entityId,
    ...
    SnapAdmin.ExtensionAPI.handle('repositoryHasChanges', (
        {
            entityName,
            entity,
        },
    ...
    SnapAdmin.ExtensionAPI.handle('repositorySaveAll', (
        {
            entityName,
            entities,
            context,
    ...
    SnapAdmin.ExtensionAPI.handle('repositoryDelete', (
        {
            entityName,
            entityId,
            context,
    ...
    SnapAdmin.ExtensionAPI.handle('repositoryCreate', (
        {
            entityName,
            entityId,
            context,
