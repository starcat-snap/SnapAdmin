...
import { send } from '@snap-admin/admin-extension-sdk/es/channel';
...
describe('src/app/init/extension-data-handling.init.ts', () => {
    ...
    beforeAll(() => {
        jest.spyOn(SnapAdmin.Service('repositoryFactory'), 'create').mockImplementation((entityName) => {
    ...
    beforeEach(() => {
        SnapAdmin.Service('repositoryFactory').create.mockClear();
    ...
    it('should handle repositorySearch', async () => {
        ...
        expect(SnapAdmin.Service('repositoryFactory').create).toHaveBeenCalledWith('product');
    ...
    it('should handle repositorySearch with integrationId', async () => {
        ...
        expect(SnapAdmin.Service('repositoryFactory').create).toHaveBeenCalledWith(
            'product',
            '',
            {
