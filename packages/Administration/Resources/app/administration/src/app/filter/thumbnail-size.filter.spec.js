describe('src/app/filter/thumbnail-size.filter.ts', () => {
    const thumbnailSizeFilter = SnapAdmin.Filter.getByName('thumbnailSize');
    const mediaThumbnailFactory = SnapAdmin.Service('repositoryFactory').create('media_thumbnail_size');
