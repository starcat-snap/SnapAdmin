...
export default {
    ...
    computed: {
        ...
        defaultLocale() {
            const adminLocaleLanguage = SnapAdmin.State.getters.adminLocaleLanguage;
    ...
    methods: {
        ...
        getZeroValues() {
            ...
            const fromDate = SnapAdmin.Utils.format.dateWithUserTimezone();
            ...
            if (this.options.xaxis.max) {
                ...
                // get actual day
                const toDate = SnapAdmin.Utils.format.dateWithUserTimezone();
