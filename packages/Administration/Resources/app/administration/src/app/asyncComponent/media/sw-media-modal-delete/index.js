...
const { Context, Mixin, Filter } = SnapAdmin;
    ...
    methods: {
        ...
        async updateSuccessNotification(successAmount, failureAmount, totalAmount) {
            ...
            if (this.notificationId !== null) {
                await SnapAdmin.State.dispatch('notification/updateNotification', {
            ...
            const newNotificationId = await SnapAdmin.State.dispatch('notification/createNotification', {
                variant: 'success',
                ...notification,
            });
