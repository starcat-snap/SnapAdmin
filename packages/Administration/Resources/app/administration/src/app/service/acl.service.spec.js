...
describe('src/app/service/acl.service.ts', () => {
    beforeEach(() => {
        ...
        SnapAdmin.Application.view.root = {};
        SnapAdmin.Application.view.root.$router = {};
        SnapAdmin.Application.view.root.$router.resolve = () => ({});
    });
    ...
    it('should return true if router is undefined', async () => {
        SnapAdmin.Application.view.root.$router = null;
