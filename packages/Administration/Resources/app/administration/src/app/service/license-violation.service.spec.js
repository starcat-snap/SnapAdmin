...
const Application = SnapAdmin.Application;
...
describe('app/service/license-violation.service.js', () => {
    SnapAdmin.Service().register('shopwareExtensionService', () => extensionApiServiceMock);
    SnapAdmin.Service().register('cacheApiService', () => cacheApiServiceMock);
