const { remove } = SnapAdmin.Utils.array;
const { Service } = SnapAdmin;
...
export default function createCustomFieldService() {
    ...
    function getCustomFieldSets(entityName) {
        ...
        return customFieldSetRepository.search(customFieldSetCriteria(entityName), SnapAdmin.Context.api).then((sets) => {
