...
import type { extension } from '@snap-admin/admin-extension-sdk/es/privileges/privilege-resolver';
import type { extensions } from '@snap-admin/admin-extension-sdk/es/channel';
import { setExtensions } from '@snap-admin/admin-extension-sdk/es/channel';
...
const ExtensionsStore: Module<extensions, VuexRootState> = {
    ...
    getters: {
        privilegedExtensionBaseUrls: state => {
            const acl = SnapAdmin.Service('acl');
