 ...
 * @private
 */
export default SnapAdmin.Mixin.register('user-settings', defineComponent({
    inject: [
        'acl',
    ],
    ...
    methods: {
        ...
        async saveUserSettings(identifier: string, entityValue: {
            ...
            if (!userSettings) {
                userSettings = this.userConfigRepository.create(SnapAdmin.Context.api);
            }
            ...
            return this.userConfigRepository.save(entityData, SnapAdmin.Context.api);
        },
        ...
        userGridSettingsCriteria(identifier: string, userId: string|null = null) {
            ...
            const criteria = new SnapAdmin.Data.Criteria(1, 25);
            criteria.addFilter(SnapAdmin.Data.Criteria.equals('key', identifier));
            criteria.addFilter(SnapAdmin.Data.Criteria.equals('userId', userId));
