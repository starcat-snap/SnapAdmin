 ...
 */
export default SnapAdmin.Mixin.register('validation', defineComponent({
    ...
    methods: {
        ...
        validate(value: any) {
            ...
            if (SnapAdmin.Utils.types.isBoolean(validation)) {
                return validation;
            }

            if (SnapAdmin.Utils.types.isString(validation)) {
            ...
            if (SnapAdmin.Utils.types.isArray(validation)) {
                valid = validation.every((validationRule) => {
                    if (SnapAdmin.Utils.types.isBoolean(validationRule)) {
