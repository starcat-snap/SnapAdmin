...
SnapAdmin.Service().register('localeHelper', () => {
    return {
...
describe('ASYNC app/adapter/view/vue.adapter.js', () => {
    ...
    beforeEach(async () => {
        ...
        if (!SnapAdmin.Service('loginService')) {
        ...
        if (!SnapAdmin.Service('localeToLanguageService')) {
            SnapAdmin.Service().register('localeToLanguageService', () => {
                return {
    ...
    it('setLocaleFromUser should not set the user when user does not exists', async () => {
        ...
        expect(SnapAdmin.Service('localeHelper').setLocaleWithId).not.toHaveBeenCalled();
    });
    ...
    it('setLocaleFromUser should set the user when user does not exists', async () => {
        ...
        expect(SnapAdmin.Service('localeHelper').setLocaleWithId).toHaveBeenCalled();
    });
    ...
    it('setLocaleFromUser should call the service with the user id from the store', async () => {
        ...
        expect(SnapAdmin.Service('localeHelper').setLocaleWithId).toHaveBeenCalledWith(expectedId);
    });

    it('should resolve mixins by explicit Mixin get by name call', async () => {
        SnapAdmin.Mixin.register('foo1', {
            methods: {
                fooBar() {
                    return this.title;
                },
        ...
        SnapAdmin.Component.register('test-component1', {
            template: '<div></div>',
            ...
            mixins: [
                SnapAdmin.Mixin.getByName('foo1'),
            ],
            methods: {
                bar() {
                    return 'bar';
        ...
        SnapAdmin.Component.markComponentAsSync('test-component1');
    ...
    it('should resolve mixins by explicit Mixin get by name call with override', async () => {
        ...
        SnapAdmin.Component.register('test-component2', {
            template: '<div></div>',
            ...
            mixins: [
                SnapAdmin.Mixin.getByName('foo2'),
            ],
            methods: {
                bar() {
                    return 'bar';
        ...
        SnapAdmin.Component.override('test-component2', {
            data() {
                return {
        ...
        SnapAdmin.Component.markComponentAsSync('test-component2');
    ...
    it('should resolve mixins by string', async () => {
        ...
        SnapAdmin.Component.register('test-component3', {
            template: '<div></div>',
        ...
        SnapAdmin.Component.markComponentAsSync('test-component3');
    ...
    it('should resolve mixins by string with override', async () => {
        ...
        SnapAdmin.Component.register('test-component4', {
            template: '<div></div>',
        ...
        SnapAdmin.Component.override('test-component4', {
            data() {
                return {
        ...
        SnapAdmin.Component.markComponentAsSync('test-component4');
    ...
    it('should resolve mixins for component in combination with overrides', async () => {
        SnapAdmin.Mixin.register('foo-with-data', {
            data() {
                return {
                    sortBy: null,
                };
        ...
        SnapAdmin.Component.register('test-component-foobar-with-mixin', {
            template: '<div></div>',
            name: 'test-component',
            data() {
                return {
        ...
        SnapAdmin.Component.markComponentAsSync('test-component-foobar-with-mixin');
        ...
        SnapAdmin.Component.override('test-component-foobar-with-mixin', {});
    ...
    it('should extend mixins', async () => {
        SnapAdmin.Mixin.register('swFoo', {
            methods: {
                fooBar() {
                    return this.title;
                },
        ...
        SnapAdmin.Mixin.register('swBar', {
            methods: {
                biz() {
                    return this.title;
                },
        ...
        SnapAdmin.Component.register('extendable-component', {
        ...
        SnapAdmin.Component.extend('sw-test-component-extended', 'extendable-component', {
        ...
        SnapAdmin.Component.markComponentAsSync('sw-test-component-extended');
    ...
    it('should allow multi-inheritance with multiple mixins and lifecycle hooks are only executed once', async () => {
        ...
        SnapAdmin.Mixin.register('first-mixin', {
            created() {
                lifecycleSpy();
            },
            methods: {
        ...
        SnapAdmin.Mixin.register('second-mixin', {
            methods: {
                bar() { return 'bar'; },
            },
        });
        ...
        SnapAdmin.Component.override('base-component', {
            mixins: ['first-mixin'],
        });
        ...
        SnapAdmin.Component.markComponentAsSync('base-component');
    ...
    describe('should initialize everything correctly', () => {
        ...
        beforeEach(async () => {
            ...
            if (!SnapAdmin.Filter.getByName('my-mock-filter')) {
                SnapAdmin.Filter.register('my-mock-filter', () => {
                    return 'mocked';
                });
            }

            if (!SnapAdmin.Directive.getByName('my-mock-directive')) {
                SnapAdmin.Directive.register('my-mock-directive', () => {
                    return {
                        bind() {},
                        inserted() {},
                        update() {},
            ...
            // add main component
            if (!SnapAdmin.Component.getComponentRegistry().has('sw-admin')) {
                SnapAdmin.Component.register('sw-admin', {
                    template: '<div class="sw-admin"></div>',
                });
            }

            // add VueAdapter to SnapAdmin object
            SnapAdmin.Application.setViewAdapter(vueAdapter);
        ...
        it('should have correct working createTitle method', () => {
            ...
            expect(result).toBe('Test | Mock title | Text SnapAdmin Admin');
        });
        ...
        it('should setup the devtools in development environment', async () => {
            expect(setupSnapAdminDevtools).toHaveBeenCalled();
        });
