 ...
 * @private
 */
export default function setupSnapAdminDevtools(app: App): void {
    setupDevtoolsPlugin({
        // Options
        id: 'sw-admin-extension-plugin',
        label: 'SnapAdmin Admin extensions plugin',
        ...
        api.on.getInspectorTree((payload) => {
            ...
            const publishedDatasets = SnapAdmin.ExtensionAPI.getPublishedDataSets();
        ...
        api.on.getInspectorState((payload) => {
            ...
            if (payload.nodeId.startsWith(DATASET_ID_PREFIX)) {
                ...
                const value = SnapAdmin.ExtensionAPI.getPublishedDataSets()
