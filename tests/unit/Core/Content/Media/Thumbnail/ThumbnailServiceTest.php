...
namespace SnapAdmin\Tests\Unit\Core\Content\Media\Thumbnail;
...
use SnapAdmin\Core\Content\Media\Aggregate\MediaThumbnailSize\MediaThumbnailSizeEntity;
...
use SnapAdmin\Core\Test\Stub\DataAbstractionLayer\StaticEntityRepository;
...
class ThumbnailServiceTest extends TestCase
{
    ...
    public function testGenerateWithValidMediaCollection(): void
    {
        ...
        $file = file_get_contents(__DIR__ . '/snap-logo.png');
    ...
    private function createMediaEntity(MediaThumbnailEntity $mediaThumbnailEntity, MediaFolderEntity $mediaFolderEntity): MediaEntity
    {
        ...
        $mediaEntity->setFileName('snap-logo');
        ...
        $mediaEntity->setPath(__DIR__ . '/snap-logo.png');
        ...
        $mediaEntity->setUrl('/url/to/snap-logo.png');
    ...
    private function createMediaThumbnailEntity(): MediaThumbnailEntity
    {
        ...
        $mediaThumbnailEntity->setPath(__DIR__ . '/snap-logo.png');
