...
namespace SnapAdmin\Tests\Unit\Core\System\SystemConfig\Api;
...
use SnapAdmin\Core\System\SystemConfig\Api\SystemConfigController;
...
class SystemConfigControllerTest extends TestCase
{
    ...
    public function testInheritFlag(Request $request, bool $expectedFlag): void
    {
        ...
        $systemConfigService->expects(static::once())
            ->method('getDomain')
            ->with('dummy domain', 'dummy scope', $expectedFlag);
