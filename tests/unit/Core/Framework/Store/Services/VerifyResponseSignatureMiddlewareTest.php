...
namespace SnapAdmin\Tests\Unit\Core\Framework\Store\Services;
...
use SnapAdmin\Core\Framework\Store\Exception\StoreSignatureValidationException;
use SnapAdmin\Core\Framework\Store\Services\OpenSSLVerifier;
use SnapAdmin\Core\Framework\Store\Services\VerifyResponseSignatureMiddleware;
...
class VerifyResponseSignatureMiddlewareTest extends TestCase
{
    ...
    {
        $response = new Response(200, ['X-SnapAdmin-Signature' => 'v3rys3cr3t'], 'response body');
    ...
    {
        $response = new Response(200, ['X-SnapAdmin-Signature' => '']);
    ...
    {
        $response = new Response(200, ['X-SnapAdmin-Signature' => 'v3rys3cr3t']);
