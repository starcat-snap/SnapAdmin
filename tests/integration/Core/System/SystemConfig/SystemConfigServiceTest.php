...
namespace SnapAdmin\Tests\Integration\Core\System\SystemConfig;
...
use SnapAdmin\Core\System\SystemConfig\SystemConfigLoader;
...
class SystemConfigServiceTest extends TestCase
{
    ...
    public function testSetGetScope(): void
    {
        $this->systemConfigService->set('foo.bar', 'test');
        $actual = $this->systemConfigService->get('foo.bar', TestDefaults::SCOPE_ID);
        static::assertEquals('test', $actual);

        $this->systemConfigService->set('foo.bar', 'override');
        $actual = $this->systemConfigService->get('foo.bar', TestDefaults::SCOPE_ID);
        static::assertEquals('override', $actual);

        $this->systemConfigService->set('foo.bar', '', TestDefaults::SCOPE_ID);
        $actual = $this->systemConfigService->get('foo.bar', TestDefaults::SCOPE_ID);
        static::assertEquals('', $actual);
    }

    public function testSetGetScopeBool(): void
    {
        $this->systemConfigService->set('foo.bar', false);
        $actual = $this->systemConfigService->get('foo.bar', TestDefaults::SCOPE_ID);
        static::assertFalse($actual);

        $this->systemConfigService->set('foo.bar', true, TestDefaults::SCOPE_ID);
        $actual = $this->systemConfigService->get('foo.bar', TestDefaults::SCOPE_ID);
    ...
    public function testGetDomainNoData(): void
    {
        ...
        $actual = $this->systemConfigService->getDomain('foo', TestDefaults::SCOPE_ID);
        static::assertEquals([], $actual);

        $actual = $this->systemConfigService->getDomain('foo', TestDefaults::SCOPE_ID, true);
        static::assertEquals([], $actual);
    }
    ...
    public function testGetDomain(): void
    {
        ...
        $this->systemConfigService->set('foo.c', 'c override', TestDefaults::SCOPE_ID);
    ...
    {
        $this->systemConfigService->set('foo.bar', 'test');
        $this->systemConfigService->set('foo.bar', 'override', TestDefaults::SCOPE_ID);
        $this->systemConfigService->set('foo.bar', '', TestDefaults::SCOPE_ID);
    ...
    public function testGetDomainInheritWithBooleanValue(): void
    {
        ...
        $this->systemConfigService->set('foo.bar', false, TestDefaults::SCOPE_ID);
        $actual = $this->systemConfigService->getDomain('foo', TestDefaults::SCOPE_ID, true);
    ...
    public function testDeleteNonExisting(): void
    {
        ...
        $this->systemConfigService->delete('not.found', TestDefaults::SCOPE_ID);
    }
    ...
    public function testDelete(): void
    {
        ...
        $actual = $this->systemConfigService->get('foo', TestDefaults::SCOPE_ID);
        static::assertEquals('bar override', $actual);

        $this->systemConfigService->delete('foo', TestDefaults::SCOPE_ID);
        $actual = $this->systemConfigService->get('foo', TestDefaults::SCOPE_ID);
        static::assertNull($actual);
    }
    ...
    public function testSetInvalidScopeThrows(): void
    {
